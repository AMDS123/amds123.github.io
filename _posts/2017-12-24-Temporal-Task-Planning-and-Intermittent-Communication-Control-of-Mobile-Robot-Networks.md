---
layout: post
title: "Temporal Task Planning and Intermittent Communication Control of Mobile Robot Networks"
date: 2017-12-24 16:38:13
categories: arXiv_RO
tags: arXiv_RO
author: Yiannis Kantaros, Meng Guo, Michael M. Zavlanos
mathjax: true
---
...
在本文中，我们为移动机器人团队开发了一个分散的间歇通信和任务规划框架。机器人的目标是完成由当地线性时间逻辑公式捕获的复杂任务，并将收集到的信息与所有其他机器人共享，也可能与用户分享。具体而言，我们考虑机器人通信能力不足以形成可靠和连接的网络，而机器人完成其任务的情况。在这种情况下，间歇通信协议是必要的，允许机器人暂时断开与网络的连接，以完成他们没有通信限制的任务。我们假设机器人只能在太空中的相同位置相遇才能相互沟通。我们的分散控制框架共同决定了所有机器人能够完成指定的时间任务的本地计划，保证无限频繁交换信息的通信事件序列，以及最小化用户指定度量的最佳通信位置。仿真和实验结果验证了所提出的控制器的有效性。

##### URL
[http://arxiv.org/abs/1706.00765](http://arxiv.org/abs/1706.00765)

##### PDF
[http://arxiv.org/pdf/1706.00765](http://arxiv.org/pdf/1706.00765)
