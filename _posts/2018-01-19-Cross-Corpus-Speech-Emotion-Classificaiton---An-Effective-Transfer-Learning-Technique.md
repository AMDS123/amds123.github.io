---
layout: post
title: "Cross Corpus Speech Emotion Classificaiton - An Effective Transfer Learning Technique"
date: 2018-01-19 10:16:11
categories: arXiv_CV
tags: arXiv_CV Sparse Transfer_Learning Deep_Learning Recognition
...
跨语料的语音情感识别可以是一种有用的传递学习技术，通过利用来自各种语言数据集的信息（跨语言和跨语料库）来构建鲁棒的语音情感识别系统。然而，需要进一步研究跨语料语音情感识别的有效操作场景，特别是利用强大的深度学习技术。在本文中，我们使用三种不同语言的五个不同语料库来研究深信仰网络（DBN）的跨语料和跨语言情感识别。实验结果表明，具有泛化能力的DBN比基于稀疏自动编码器和支持向量机的判别方法具有更好的精度。结果还表明，与使用相同的语言进行训练和测试相比，使用大量语言进行训练并在训练中使用一小部分目标数据可显着提高准确性。

##### URL
[http://arxiv.org/abs/1801.06353](http://arxiv.org/abs/1801.06353)

##### PDF
[http://arxiv.org/pdf/1801.06353](http://arxiv.org/pdf/1801.06353)
