...
视频是高维结构化数据的丰富来源，具有不同粒度级别的各种交互组件。为了提高对不受约束的互联网视频的理解，重要的是考虑标签在不同抽象层次上的角色。在本文中，我们考虑使用双向推理神经网络（BINN）在标签空间中执行基于图形的推断以用于视频分类任务。我们利用标签之间固有的层次结构来增加粒度。 BINN将在YouTube-8M大规模多标签视频数据集的第一个和第二个版本上进行评估。我们的研究结果证明了BINN的有效性，实现了对基准模型的显着改进。

##### URL
[http://arxiv.org/abs/1706.05028](http://arxiv.org/abs/1706.05028)

##### PDF
[http://arxiv.org/pdf/1706.05028](http://arxiv.org/pdf/1706.05028)
