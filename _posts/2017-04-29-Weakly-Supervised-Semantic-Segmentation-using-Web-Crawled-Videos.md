...
date: 2017-04-29 03:00:28
categories: arXiv_CV
tags: arXiv_CV Segmentation Weakly_Supervised Image_Classification Semantic_Segmentation Classification
...
我们提出了一种新的基于图像级别标签的弱监督语义分割算法。在弱监督的环境中，通常观察到，训练过的模型过度地关注区分的部分而不是整个对象区域。我们的目标是克服这个限制，不需要额外的人工干预，从网络存储库中检索与目标类标签相关的视频，并从检索的视频中生成分割标签，以模拟对语义分割的强大监督。在此过程中，我们利用带有区分性定位技术的图像分类来拒绝检索到的视频中的虚假警报，并在检索到的视频中识别相关的时空体积。虽然整个过程不需要任何额外的监督，但从视频获得的分割注释足够强，以学习语义分割的模型。所提出的算法在基于相同监督水平的情况下大大优于现有方法，甚至与依赖额外注释的方法相比具有竞争性。

##### URL
[https://arxiv.org/abs/1701.00352](https://arxiv.org/abs/1701.00352)

##### PDF
[https://arxiv.org/pdf/1701.00352](https://arxiv.org/pdf/1701.00352)
