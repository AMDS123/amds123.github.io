...
date: 2017-06-28 14:15:31
categories: arXiv_CV
tags: arXiv_CV
author: Abraham Smith, Paul Bendich, John Harer, Jay Hineman
mathjax: true
---
...
我们引入了一种新的算法，称为CDER，用于监督机器学习，将Cover Trees的多尺度几何性质与熵的信息论性质相结合。 CDER适用于嵌入共同欧几里德空间的标记点云的训练集。如果对应于不同标签的典型点云在任何子区域的任何尺度上倾向于不同，则CDER可以在（通常）线性时间中识别这些差异，从而创建一组分布坐标，作为监督学习的特征提取机制。我们描述CDER的理论性质和实施细节，并说明它在几个合成实例中的好处。

##### URL
[https://arxiv.org/abs/1702.07959](https://arxiv.org/abs/1702.07959)

##### PDF
[https://arxiv.org/pdf/1702.07959](https://arxiv.org/pdf/1702.07959)
