...
神经机器翻译（NMT）近来取得了显着的成绩。但这种方法在维汉翻译任务中并没有得到广泛的应用，部分原因是由于维吾尔语中的并行数据资源有限，以及由于维吾尔文的粘着性而造成的罕见词的比例较大。在这篇论文中，我们收集了大约20万个句子对，表明在这个中等规模的数据库中，一个注意力的NMT可以很好地表达中国 - 维吾尔族/维吾尔族 - 中国人的翻译。为了处理难得的单词，我们提出了一种新的内存结构来辅助NMT推理。我们的实验表明，记忆增强NMT（M-NMT）优于香草NMT和基于短语的统计机器翻译（SMT）。有趣的是，内存结构为处理超出词汇量的单词提供了一种优雅的方式。
