...
date: 2017-11-29 09:48:06
categories: arXiv_SD
tags: arXiv_SD
author: Charles P. Martin, Jim Torresen
mathjax: true
---
...
RoboJam是一种用于生成音乐的机器学习系统，通过对短暂的即兴创作进行响应来协助触摸屏音乐应用的用户。该系统使用循环人工神经网络来产生触摸屏交互和绝对定时序列，而不是高级音符。为了实现这一点，RoboJam的网络使用混合密度层来预测空间和时间的适当的触摸交互位置。在本文中，我们描述了RoboJam网络的设计和实现，以及它如何被集成到触摸屏音乐应用程序中。初步评估分析系统在训练，音乐生成和用户交互方面。
