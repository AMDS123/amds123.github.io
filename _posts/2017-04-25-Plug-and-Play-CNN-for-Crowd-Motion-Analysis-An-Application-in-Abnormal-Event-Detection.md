...
date: 2017-04-25 12:17:02
categories: arXiv_CV
tags: arXiv_CV CNN Detection
author: Mahdyar Ravanbakhsh, Moin Nabi, Hossein Mousavi, Enver Sangineto, Nicu Sebe
mathjax: true
---
...
大多数人群异常事件检测方法依靠复杂的手工特征来表示人群的运动和外观。卷积神经网络（CNN）已经被证明是一个具有优秀表现能力的强大工具，可以充分利用对手工特征的需求。在本文中，我们表明跟踪CNN功能随时间的变化可以有助于捕捉本地异常情况。我们特别提出了一种新颖的基于测量的方法，它允许通过将语义信息（从现有的CNN模型继承）与低级光流相结合来测量视频中的局部异常。这种方法的优点之一是它可以在没有微调成本的情况下使用。提出的方法验证了异常检测数据集的挑战性，结果显示了我们的方法相比，先进的方法的优越性。

##### URL
[https://arxiv.org/abs/1610.00307](https://arxiv.org/abs/1610.00307)

##### PDF
[https://arxiv.org/pdf/1610.00307](https://arxiv.org/pdf/1610.00307)
