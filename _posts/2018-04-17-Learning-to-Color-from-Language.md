...
自动着色是向灰度图像添加颜色的过程。我们根据语言对这个过程进行了调整，允许最终用户通过输入不同的标题来操作彩色图像。我们提出了两种不同的语言条件着色体系结构，它们都比语言无关的版本产生更准确和合理的颜色。通过这种基于语言的框架，我们可以通过操作字幕中的描述性颜色词来显着改变颜色。

##### URL
[https://arxiv.org/abs/1804.06026](https://arxiv.org/abs/1804.06026)

##### PDF
[https://arxiv.org/pdf/1804.06026](https://arxiv.org/pdf/1804.06026)
