...
date: 2018-07-23 23:06:52
categories: arXiv_CV
tags: arXiv_CV Salient Object_Detection Weakly_Supervised Classification Deep_Learning Detection
...
关于如何解释深度学习模型（DLM）提供的决策存在激烈的争论，其中主要方法依赖于显着区域的可视化来解释DLM分类过程。然而，这些方法通常不能满足医学图像中病变检测问题的三个条件：1）对于有病变的图像，所有显着区域应代表病变，2）对于不含病变的图像，不应产生显着区域，以及3）病变通常很小，边界相对平滑。我们提出了一种新的模型不可知范式来解释DLM分类决策，该决策由包含上述条件的新颖显着性定义支持。我们的模型不可知1级显着性检测器（MASD）在DCE-MRI的弱监督乳房病变检测中进行测试，与当前的可视化方法相比，实现了最先进的检测精度。

##### URL
[https://arxiv.org/abs/1807.07784](https://arxiv.org/abs/1807.07784)

##### PDF
[https://arxiv.org/pdf/1807.07784](https://arxiv.org/pdf/1807.07784)
