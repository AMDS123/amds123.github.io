...
生成新颖的图像和文本对是计算机视觉和自然语言处理相结合的一个问题。在本文中，我们提出了基于现有字幕数据集生成新的图像和字幕对的策略。该模型利用了生成敌对网络和序列到序列建模的最新进展。我们做一般化来生成来自多个域的配对样本。此外，我们研究循环 - 从图像到文本，然后返回到图像，反之亦然，以及它与自动编码器的连接。

##### URL
[http://arxiv.org/abs/1712.06682](http://arxiv.org/abs/1712.06682)

##### PDF
[http://arxiv.org/pdf/1712.06682](http://arxiv.org/pdf/1712.06682)
