...
date: 2018-06-25 14:21:37
categories: arXiv_SD
tags: arXiv_SD Adversarial Relation
...
对参数估计和再合成任务中使用的物理建模弓弦合成器的已知参数进行条件化的敌对自动编码器进行评估。提供潜在维度以捕获并非由条件参数解释的变化。结果与有和无对抗训练进行比较，并且检查能够“复制”给定参数信号双向关系的系统。一个基于生成，条件化和规则化神经网络的实时综合系统被提出，允许纯粹基于记录的数据构建引人入胜的声音合成器。

##### URL
[http://arxiv.org/abs/1806.09617](http://arxiv.org/abs/1806.09617)

##### PDF
[http://arxiv.org/pdf/1806.09617](http://arxiv.org/pdf/1806.09617)
