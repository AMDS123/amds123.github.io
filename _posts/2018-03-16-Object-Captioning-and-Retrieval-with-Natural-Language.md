...
date: 2018-03-16 10:32:25
categories: arXiv_CV
tags: arXiv_CV Caption Inference RNN
...
我们解决了共同学习视觉和语言的问题，以便以细粒度的方式理解对象。我们的方法的关键思想是使用对象描述来提供对对象的详细理解。基于这个想法，我们提出了两个新的架构来解决两个相关的问题：对象字幕和基于自然语言的对象检索。对象字幕任务的目标是同时检测对象并生成其相关描述，而在对象检索任务中，目标是在给定输入查询的情况下本地化对象。我们证明使用混合端到端CNN-LSTM网络可以有效地解决这两个问题。我们新的具有挑战性的数据集的实验结果表明，我们的方法在很大程度上优于最近的方法，同时提供了对对象的详细理解和快速推理时间。源代码将可用。

##### URL
[https://arxiv.org/abs/1803.06152](https://arxiv.org/abs/1803.06152)

##### PDF
[https://arxiv.org/pdf/1803.06152](https://arxiv.org/pdf/1803.06152)
