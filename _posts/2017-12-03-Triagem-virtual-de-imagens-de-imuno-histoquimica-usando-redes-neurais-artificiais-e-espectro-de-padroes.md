...
categories: arXiv_CV
tags: arXiv_CV Image_Retrieval GAN Image_Classification Classification
...
组织医学图像根据其性质，应用和相关性的重要性正在增加。另外，以前选择的医学图像对于加速病理学家的分析任务可能是有用的。在这里，我们提出了一个图像分类器来整合CBIR（基于内容的图像检索）选择系统。该分类器基于模式谱和神经网络。特征选择使用模式谱和主成分分析，而图像分类基于多层感知器和自组织映射和学习矢量量化的组合。这些方法被应用于胎盘和新生儿肺的免疫组织化学图像的内容选择。结果表明，这种方法可以达到合理的分类性能。

##### URL
[http://arxiv.org/abs/1712.01695](http://arxiv.org/abs/1712.01695)

##### PDF
[http://arxiv.org/pdf/1712.01695](http://arxiv.org/pdf/1712.01695)
