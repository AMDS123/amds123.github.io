...
我们描述了一个系统，自动过滤计算机断层扫描（CT）头部扫描的临床意义重大发现，在超过执业放射科医师的表现水平上运作。我们的系统名为DeepRadiologyNet，它建立在深度卷积神经网络（CNNs）的基础之上，该网络使用从2015年1月1日至2015年8月31日以及2016年1月1日至2016年4月30日的24,000多项研究中收集的大约350万个CT头像在80多个临床地点。对于我们最初的系统，我们确定了30个在CT扫描中被识别的现象学特征。为了测试该系统，我们设计了一个临床试验，使用超过480万个CT头部图像（29,925个研究），完全脱离了培训和验证集，由具有专业CT头部经验的35名美国委员会认证放射科医生解释。我们测量了临床上显着的错误率，以确定DeepRadiologyNet的性能是否与美国董事会认证的放射科医师相当或更好。在自动选择的高信度研究中，DeepRadiologyNet达到0.0367％的临床显着失败率。因此，DeepRadiologyNet能够通过自动过滤研究并在低于美国理事会认证放射科医师的字面错误率的操作点报告高可信度的研究，从而显着减少人类放射科医生的工作量，估计为0.82％。
