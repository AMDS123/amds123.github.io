---
layout: post
title: "CapsDeMM: Capsule network for Detection of Munrotextquoteright s Microabscess in skin biopsy images"
date: 2018-08-20 12:50:41
categories: arXiv_CV
...
本文介绍了一种自动检测人体皮肤活检角质层中的Munro \ textquoteright Microabscess的方法，以实现对银屑病的机器辅助诊断。使用深度学习算法的最新进展解决了在有核细胞存在下检测中性粒细胞的挑战。 SC层的分离，从层中提取贴片，然后根据是否存在中性粒细胞对贴片进行分类，形成整体方法的基础，该方法通过基于U-Net的分割网络和胶囊网络的集成来实现。分类。本胶囊网的新颖设计导致参数数量的急剧减少，而在整体性能上没有任何明显的折衷。该研究进一步解决了处理百万像素图像（10倍）与千兆像素（40倍）相比的挑战。在由273美元现实生活图像组成的数据集实验中得出的有希望的结果表明，基于目前的研究，实际系统是可行的。可以在〜\ url {https://github.com/Anabik/CapsDeMM}上找到我们系统的实现。

##### URL
[http://arxiv.org/abs/1808.06428](http://arxiv.org/abs/1808.06428)

##### PDF
[http://arxiv.org/pdf/1808.06428](http://arxiv.org/pdf/1808.06428)
