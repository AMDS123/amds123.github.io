...
在过去的几十年里，像Twitter这样的社交网络服务已经产生了大量关于用户和他们的兴趣的数据，提供了有意义的商业智能，使得组织可以更好地理解和吸引他们的客户。所有的企业都想知道是谁在宣传他们的产品，谁在抱怨他们，这些观点如何给公司带来或减少价值。公司希望能够识别他们的高价值客户，并量化每个用户带来的价值。许多企业使用社交媒体指标来计算用户贡献分数，这使得他们能够量化有影响力的用户对社交媒体的价值，因此企业可以为他们提供更多差异化的服务。但是，分数计算可以被细化以提供用户贡献的更好的图示。以微软Azure为案例研究，我们进行了Twitter情感分析，以开发一个机器学习分类模型，该模型可以识别最具说明性的正面价值用户贡献的微博内容和情感。使用数据挖掘和AI支持的认知工具，我们分析了开发者社区中社交影响因素，特别是促销语言。我们的预测模型是传统监督机器学习算法和定制开发自然语言模型的组合，用于识别促销推文，以90％的准确率在Twitter上标识特定产品的推广。
