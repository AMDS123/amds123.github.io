...
date: 2017-05-03 17:13:25
categories: arXiv_CV
tags: arXiv_CV Object_Detection Detection
author: Alexander H. Nitz, Thomas Dent, Tito Dal Canton, Stephen Fairhurst, Duncan A. Brown
mathjax: true
---
...
我们提出了一个改进的搜索二进制紧凑对象合并使用基于地面的引力波探测器网络。我们建模一个体积，各向同性的源数据，并将所得到的信号幅度，时间延迟和聚并阶段的分布结合到候选事件的排序中。我们描述了一个改进的背景分布建模，并且展示了将二进制质量分布的先验模型结合到候选事件的排名中。我们发现仿真二元中子星和中子星 - 二元黑洞系统的检测体积分别增加了$ \ sim 10 \％$和$ \ sim 20 \％$，相应的虚警率降低了信号在一到两个数量级之间。
