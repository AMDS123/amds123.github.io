...
摄像机参数不仅在确定感知图像的视觉质量方面发挥重要作用，而且还影响视觉引导机器人视觉算法的性能。通过定量评估四种物体检测算法，就变化的环境照明，快门速度和电压增益而言，观察到算法的性能高度依赖于这些变量。从这个观察中，提出了一种新的摄像机参数主动控制方法，使机器人视觉在不同的光照条件下更加鲁棒。实验结果证明了我们提出的方法的有效性，与传统的自动曝光算法相比，提高了目标检测算法的性能。
