...
date: 2017-05-27 04:29:04
categories: arXiv_CV
tags: arXiv_CV Adversarial Deep_Learning
author: Chang Song, Hsin-Pai Cheng, Chunpeng Wu, Hai Li, Yiran Chen, Qing Wu
mathjax: true
---
...
最近的一些研究表明，深度神经网络（DNNs）容易受到所谓的对抗性攻击的影响，因为输入的例子被故意扰乱为愚蠢的DNNs。在这项工作中，我们重新审视了包括敌对案例在内的DNN训练过程，以提高DNN对抗攻击的抵御能力，即对抗训练。我们的实验表明，不同的对抗强度，即对抗性事例的扰动水平，具有不同的工作区域来抵抗攻击。基于观察，我们提出了一种多强度对抗训练方法（MAT），它将对抗训练的例子与不同的对抗强项相结合，以防御对抗性攻击。两种训练结构 - 混合MAT和平行MAT  - 被开发来促进训练时间和记忆占用之间的权衡。我们的研究结果表明，MAT可以大大降低深度学习系统对MNIST，CIFAR-10，CIFAR-100和SVHN的对抗性攻击的准确性下降。

##### URL
[https://arxiv.org/abs/1705.09764](https://arxiv.org/abs/1705.09764)

##### PDF
[https://arxiv.org/pdf/1705.09764](https://arxiv.org/pdf/1705.09764)
