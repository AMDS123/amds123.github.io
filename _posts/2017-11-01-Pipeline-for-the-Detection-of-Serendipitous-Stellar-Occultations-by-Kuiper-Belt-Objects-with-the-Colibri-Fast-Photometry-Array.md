---
layout: post
title: "Pipeline for the Detection of Serendipitous Stellar Occultations by Kuiper Belt Objects with the Colibri Fast-Photometry Array"
date: 2017-11-01 14:25:32
categories: arXiv_CV
tags: arXiv_CV Detection
author: Emily Pass, Stanimir Metchev, Peter Brown, Steven Beauchemin
mathjax: true
---
...
我们报告了Colibri的初步试验结果，这是一种专用的快速测光阵列，用于通过偶然的恒星掩星探测小型柯伊伯带状物体。 Colibri的新型数据处理流程使用两个重叠场EMCCD相机分析4000星时，在高黄道纬度场中未检测到柯伊伯带对象和一个假阳性掩星事件。在这些纬度地区不会发生掩星，这些结果可为即将到来的主要Colibri活动提供对照样本。处理流水线发现的经验假阳性率与模拟确定的0.002％假阳性率一致。我们还描述了Colibri的软件设计，用于建模恒星掩星的核函数集，以及从噪声衍射曲线中提取掩星参数的方法。 Colibri的主要活动将在2018年年中开始，以40 Hz的采样率运行。
