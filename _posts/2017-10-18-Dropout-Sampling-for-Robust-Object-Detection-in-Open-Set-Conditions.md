...
categories: arXiv_CV
tags: arXiv_CV Object_Detection Image_Classification Inference Classification Deep_Learning Detection
...
Dropout Variational Inference或Dropout Sampling最近被提出作为贝叶斯深度学习的一种近似技术，并被评估用于图像分类和回归任务。本文首次研究了Dropout Sampling技术在物体检测中的应用。我们演示了标签不确定性如何通过Dropout Sampling从最先进的物体检测系统中提取出来。我们表明，这种不确定性可以用来增加在机器人视觉中通常遇到的开放条件下的物体检测性能。我们在具有30,000个图像的大型合成数据集上评估这种方法，并且在多功能校园环境中由移动机器人捕获真实世界的数据集。
