...
date: 2017-08-28 06:07:27
categories: arXiv_CV
tags: arXiv_CV Attention Face Classification Deep_Learning Recognition Face_Recognition
...
野外标记人脸（LFW）数据库已被广泛用作无约束面部验证的基准，并且由于大数据驱动的机器学习方法，数据库上的性能接近100％。但是，我们认为，由于某些限制因素，这个准确性可能过于乐观。除了不同的姿势，灯光，遮挡和表情之外，跨时代的人脸也是人脸识别的另一个挑战。同一个人的不同年龄导致大的班内变化，老化过程在现实世界中的面部验证是不可避免的。但是，LFW并没有太在意。因此，我们构造了一个跨年龄LFW（CALFW），故意搜索和选择年龄差距的3000个正面人脸对，以增加老化过程中的类内差异。同时选取同性别，不同种族的负性对，减少正负对之间属性差异的影响，实现人脸验证而不是属性分类。我们在新的数据库上评估几种度量学习和深度学习方法。与LFW的精度相比，CALFW的精度下降了10％-17％左右。

##### URL
[https://arxiv.org/abs/1708.08197](https://arxiv.org/abs/1708.08197)

##### PDF
[https://arxiv.org/pdf/1708.08197](https://arxiv.org/pdf/1708.08197)
