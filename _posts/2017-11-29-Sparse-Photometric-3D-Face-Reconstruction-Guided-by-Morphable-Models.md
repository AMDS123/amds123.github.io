...
我们提出了一种新颖的三维人脸重建技术，利用稀疏光度立体（PS）和最新进展的人脸登记/建模从一个单一的形象。我们观察到，三维形变面临的办法提供了一个合理的几何代理灯位置校准。具体来说，我们开发了一种强大的优化技术，可以非常高的精度校准每像素的照明方向和照度，而不会假设均匀的表面反照率。接下来，我们对输入图像和几何代理应用语义分割，以使用定制过滤器来优化毛发与裸露皮肤区域。对合成和真实数据的实验表明，通过使用非常小的一组图像，我们的技术能够重建细微的几何细节，如皱纹，眉毛，小苍蝇，毛孔等，可与电影质量相媲美，甚至有时超越。
