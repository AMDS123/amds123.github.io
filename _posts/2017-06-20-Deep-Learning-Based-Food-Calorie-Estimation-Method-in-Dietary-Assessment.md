...
肥胖治疗要求肥胖患者每天记录所有食物摄入量。已经引入计算机视觉来估计来自食物图像的卡路里。为了提高检测的准确性和减少食物卡路里估计中的体积估计误差，本文提出了卡路里估计方法。要估计食物的卡路里，需要顶视图和侧视图。使用更快的R-CNN来检测食物和校准物体。 GrabCut算法用于获取每个食物的轮廓。然后用食物和相应的物体估计音量。最后我们估计每种食物的卡路里。实验结果表明我们的估计方法是有效的。

##### URL
[https://arxiv.org/abs/1706.04062](https://arxiv.org/abs/1706.04062)

##### PDF
[https://arxiv.org/pdf/1706.04062](https://arxiv.org/pdf/1706.04062)
