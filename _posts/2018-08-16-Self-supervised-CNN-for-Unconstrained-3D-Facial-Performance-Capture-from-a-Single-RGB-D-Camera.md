---
layout: post
title: "Self-supervised CNN for Unconstrained 3D Facial Performance Capture from a Single RGB-D Camera"
date: 2018-08-16 01:59:15
categories: arXiv_CV
tags: arXiv_CV Regularization Sparse Face Deep_Learning
...
我们提出了一种使用消费级RGB-D传感器进行实时3D面部表现捕获的新方法。我们的捕捉系统的目标是在野外进行稳健而稳定的3D人脸捕捉，其中RGB-D面部数据包含噪点，不完美和遮挡，并且通常在运动，姿势，表情和光照条件方面表现出高度可变性，从而带来巨大挑战。技术贡献是一个自我监督的深度学习框架，它直接从原始RGB-D数据进行培训。关键的新颖之处包括：（1）学习核心张量和用于细化参数化人脸模型的参数; （2）利用顶点位移和UV图来学习表面细节; （3）通过结合基于RGB-D图像对的时间相干性和相同的身份约束并利用稀疏规范来设计损失函数，以及光学一致性，特征相似性，正则化以及几何一致性的传统术语; （4）以新的方式增加训练数据集。该方法在智能手机和RGB-D传感器上实时运行的实时设置中进行了演示。大量实验表明，我们的方法对严重遮挡，快速运动，大旋转，夸张的面部表情和多样化的照明具有鲁棒性。

##### URL
[http://arxiv.org/abs/1808.05323](http://arxiv.org/abs/1808.05323)

##### PDF
[http://arxiv.org/pdf/1808.05323](http://arxiv.org/pdf/1808.05323)
