...
date: 2018-01-13 19:38:21
categories: arXiv_CL
tags: arXiv_CL Face Speech_Recognition CNN RNN Quantitative Detection Recognition
...
深卷积神经网络正在被广泛的语音和音频处理应用（包括语音识别，音频事件检测和计算语言学）中进行积极的研究，这是因为它们能够减少变化因素，从语音学习。然而，研究表明在建立用于语音应用的深度卷积神经网络时某种类型的卷积操作是有利的，尽管使用不同类型的卷积操作已经有了令人鼓舞的结果。在这项工作中，我们研究了四种不同输入特征的卷积运算，在嘈杂和干净的条件下进行语音情感识别，以获得全面的理解。由于情感行为信息已经被证明反映了精神状态的时间变化，并且卷积操作在时间上被局部地应用，所有深度神经网络共享一个深度复发的子网络架构，用于进一步的时间建模。我们提供详细的定量模块化性能分析，以深入了解所提出体系结构中的信息流。特别是，我们展示了从一个模块到另一个模块的过程中情感信息和其他不相关信息的相互作用。最后，我们展示了我们所有的深层神经网络在eNTERFACE'05语料库上提供了最先进的性能。

##### URL
[http://arxiv.org/abs/1706.02901](http://arxiv.org/abs/1706.02901)

##### PDF
[http://arxiv.org/pdf/1706.02901](http://arxiv.org/pdf/1706.02901)
