...
机器人最终将成为每个家庭的一部分。因此，使算法能够从非专家用户身上学习并受其指导是至关重要的。在本文中，我们将一个人带入循环中，使一位人类的老师能够以自然语言的形式向学习代理人提供反馈。我们认为描述性句子可以提供比数字奖励更强的学习信号，因为它可以很容易地指出错误在哪里以及如何纠正。我们关注图像字幕的问题，其中输出的质量很容易被非专家判断。我们提出了一种基于策略梯度训练的基于层级短语的字幕模型，并设计了一个反馈网络，通过调节人类反馈来为学习者提供奖励。我们表明，通过利用描述性反馈，我们的模型学习比独立书面人物字幕更好的表现。
