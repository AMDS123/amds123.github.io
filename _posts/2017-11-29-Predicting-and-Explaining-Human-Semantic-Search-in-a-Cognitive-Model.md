...
categories: arXiv_CL
tags: arXiv_CL
author: Filip Miscevic, Aida Nematzadeh, Suzanne Stevenson
mathjax: true
---
...
最近的工作试图表征语义记忆的结构和搜索算法，它们一起最好地接近语义流畅任务中揭示的人类搜索模式。有许多模型试图捕捉网络上的语义搜索过程，但是它们的实现在认知合理性上有所不同。现有的工作也忽视了语言习得增量过程对语义记忆结构的制约。在这里，我们提出一个模型，增量更新语义网络，有限的计算步骤，并复制使用一个简单的随机游走在人类语义流畅性中发现的许多模式。我们也进行了彻底的分析，表明结构和语义特征的组合与人类的表现模式相关。
