...
date: 2017-12-01 17:47:18
categories: arXiv_CL
tags: arXiv_CL
author: Michael Moortgat, Gijs Wijnholds
mathjax: true
---
...
Sadrzadeh等人（2013）用有限维向量空间的Frobenius代数结构，给出了英语关系从句的成分分布分析。分析依赖于不同的类型分配和主体与对象相对化的词汇配方。荷兰语的情况是不同的：由于荷兰语的动词最终性质，在主语与宾语相对化读数之间的关系从句是不明确的。使用Lambek演算的扩展版本，我们提出了一个构成分布框架来解释这种派生歧义，并且允许我们给出关于代表Frobenius语义与荷兰派生语法的要求相一致的关系代词的单一含义配方。
