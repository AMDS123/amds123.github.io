...
本文提出了一种使用字幕执行可变长度语义视频生成的网络体系结构。我们对视频生成采取了一种新的视角，即允许将字幕与视频帧之间的长期和短期相关性结合起来，从而以增量方式生成视频。我们的实验证明了我们的网络架构能够区分视频中的对象，操作和交互，并将它们结合起来生成不可见的标题视频。当要求为一系列字幕生成视频时，网络还具有执行时空风格传输的能力。我们还表明，网络学习潜在表示的能力允许它以无监督的方式生成视频，并执行其他任务，如动作识别。 （在计算机视觉国际会议（ICCV）2017接受）
