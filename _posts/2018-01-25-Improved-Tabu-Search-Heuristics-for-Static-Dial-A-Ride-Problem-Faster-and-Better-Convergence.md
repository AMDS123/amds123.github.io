---
layout: post
title: "Improved Tabu Search Heuristics for Static Dial-A-Ride Problem: Faster and Better Convergence"
date: 2018-01-25 09:46:42
categories: arXiv_AI
tags: arXiv_AI
...
随着自主车辆技术的快速发展，多车辆路线已变得越来越重要。拨号问题（DARP）是一种车辆路径问题（VRP）的变体，它处理客户对车辆请求的分配，通过确保高的车辆时间安排上车和下车时间以及服务这些请求的顺序客户满意度最低的旅行成本。在本文中，我们提出了一个改进的禁忌搜索（ITS）启发式的静态DARP，目的是在短时间内获得高质量的解决方案。提出了两种新的技术，初始化启发式和时间窗口调整，以实现更快的全局最优收敛。使用来自文献的DARP测试实例对所提出的解决方案方法进行各种数值实验，并验证收敛速度。

##### URL
[http://arxiv.org/abs/1801.09547](http://arxiv.org/abs/1801.09547)

##### PDF
[http://arxiv.org/pdf/1801.09547](http://arxiv.org/pdf/1801.09547)
