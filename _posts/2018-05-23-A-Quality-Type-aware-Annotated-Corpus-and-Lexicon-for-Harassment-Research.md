...
date: 2018-05-23 18:10:17
categories: arXiv_CL
tags: arXiv_CL
author: Mohammadreza Rezvan, Saeedeh Shekarpour, Lakshika Balasuriya, Krishnaprasad Thirunarayan, Valerie Shalin, Amit Sheth
mathjax: true
---
...
具有高质量的带注释的语料库对于应用研究尤其重要。尽管最近网络科学界关注网络欺凌研究的焦点，但社区仍然没有标准的基准。在本文中，我们首先发布一个高质量的注释语料库，其次是一个攻击性词汇词典，其中捕捉不同类型的骚扰为（i）性骚扰，（ii）种族骚扰，（iii）与外表相关的骚扰，（iv）知识分子骚扰，以及（v）政治骚扰。我们使用我们的进攻性词汇从Twitter上检索数据。然后依靠人类法官来注释收集的推文w.r.t.因为使用冒犯性词语不足以可靠地检测到骚扰。我们的语料库由五种上下文类型中的25,000条带注释的推文组成。我们很高兴与研究界分享这个新的带注释的语料库和词典。获取语​​料库的指令已发布在Git存储库上。

##### URL
[http://arxiv.org/abs/1802.09416](http://arxiv.org/abs/1802.09416)

##### PDF
[http://arxiv.org/pdf/1802.09416](http://arxiv.org/pdf/1802.09416)
