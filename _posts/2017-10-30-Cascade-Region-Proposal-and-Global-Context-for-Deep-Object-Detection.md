...
基于深度区域的目标检测器由区域建议步骤和深度目标识别步骤组成。在这篇文章中，我们对这两个步骤都做了重大的改进。对于区域提案，我们提出了一种新颖的轻量级联结构，可以有效提高RPN提案质量。对于对象识别，我们重新实施全局上下文建模，并进行一些修改，并获得性能提升（ILSVRC 2016验证集上的4.2％的mAP增益）。此外，我们广泛应用预培训的理念，并在两个步骤中展示其重要性。加上常见的培训和测试手段，我们大幅度提高了R-CNN的基准。尤其是，我们获得了PASCAL VOC 2012测试集的87.9％的mAP，ILSVRC 2016测试集的65.3％以及COCO测试集的36.8％。
