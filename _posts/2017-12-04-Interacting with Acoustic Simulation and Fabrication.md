...
将精确的基于物理学的模拟纳入交互式设计工具是具有挑战性的但是，准确地添加物理对于一些新兴技术来说至关重要。例如，在虚拟/增强现实（VR / AR）视频中，需要忠实再现周围的音频，以使沉浸到下一层。同样，由于个人制作可以使用可访问的3D打印机，因此更直观的工具可以帮助艺术家设计原型。一个主要的障碍是通过基于物理学的模拟来准确再现现实世界的现象的计算复杂度非常高。在我的论文研究中，我开发了交互式工具，实现高效的基于物理的仿真算法，以实现自动优化和直观的用户交互。
