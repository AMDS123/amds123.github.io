...
在这项工作中，我们提出了视觉对话模型的黑箱干预方法，目的是评估个人语言或视觉成分的贡献。具体而言，我们进行结构化或随机干预，旨在削弱模型的个别组成部分，并观察任务绩效的变化。我们重现了最先进的视觉对话模型，并证明我们的方法产生了令人惊讶的见解，即对话和图像信息对任务性能的贡献最小。这里介绍的干预方法可以作为对视觉对话系统中每个组件的强度和鲁棒性的完整性检查。
