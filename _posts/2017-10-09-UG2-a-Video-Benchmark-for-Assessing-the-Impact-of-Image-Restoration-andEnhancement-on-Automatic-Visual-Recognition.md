...
date: 2017-10-09 02:01:58
categories: arXiv_CV
tags: arXiv_CV Super_Resolution Classification Deep_Learning Recognition
...
图像恢复和增强技术的进步已经导致讨论如何将这些算法用作预处理步骤来改善自动视觉识别。原则上，去模糊和超分辨率技术应该通过降低输入图像中的噪声和增加信号来得到改善。但是，计算摄影和视觉识别社区的历史发散目标已经造成了在这个方向上进行更多工作的重大需求。为了便于进行新的研究，我们引入了一个名为UG ^ 2的新基准数据集，其中包含三个难以处理的实际情况：无人机和载人滑翔机拍摄的不受控制的视频以及在地面拍摄的受控视频。为数百个ImageNet类提供了超过160,000个注释帧，用于基线实验，评估已知和未知图像伪像以及其他条件对常见基于深度学习的对象分类方法的影响。此外，通过确定它们是否提高基线分类性能来评估当前的图像恢复和增强技术。结果表明，算法创新有很大的空间，使得这个数据集成为一个有用的工具。

##### URL
[https://arxiv.org/abs/1710.02909](https://arxiv.org/abs/1710.02909)

##### PDF
[https://arxiv.org/pdf/1710.02909](https://arxiv.org/pdf/1710.02909)
