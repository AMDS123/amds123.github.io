...
date: 2017-07-30 21:52:23
categories: arXiv_AI
tags: arXiv_AI Adversarial Super_Resolution CNN Quantitative
author: Mehdi S. M. Sajjadi, Bernhard Schölkopf, Michael Hirsch
mathjax: true
---
...
单幅图像超分辨率是从单个低分辨率输入中推断出高分辨率图像的任务。传统上，用于该任务的算法的性能是使用像素重构测量（例如，峰值信噪比（PSNR））来测量的，已经显示该信号与人类对图像质量的感知较差。结果，使这些度量最小化的算法倾向于产生缺乏高频纹理的过平滑图像，尽管产生高PSNR值，但看起来不自然。我们提出了一种自动纹理合成的新颖应用与知觉损失相结合，专注于创造逼真的纹理，而不是在训练期间对像素精确的地面真实图像的再现进行优化。通过在对抗训练环境中使用前馈完全卷积神经网络，我们在高放大率下显着提高图像质量。大量数据集上的大量实验显示了我们方法的有效性，在定量和定量基准测试中都能得出最新的结果。

##### URL
[https://arxiv.org/abs/1612.07919](https://arxiv.org/abs/1612.07919)

##### PDF
[https://arxiv.org/pdf/1612.07919](https://arxiv.org/pdf/1612.07919)
