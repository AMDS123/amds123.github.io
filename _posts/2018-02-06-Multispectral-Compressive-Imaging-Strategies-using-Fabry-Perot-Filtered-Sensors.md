---
layout: post
title: "Multispectral Compressive Imaging Strategies using Fabry-P'erot Filtered Sensors"
date: 2018-02-06 16:23:42
categories: arXiv_CV
...
本文介绍了两种多光谱压缩成像采集设备的体系结构。与大多数现有的方法不同，所提出的计算成像技术不包括任何色散元件，因为它们使用在像素级集成窄带法布里 - 珀罗滤波器的专用传感器。第一个方案利用联合修补和超分辨率来填充由于设备有限的像素数量而丢失的那些体素。第二种方案与压缩感知相结合，引入了空间随机卷积，但更复杂，可能受到衍射的影响。在这两种情况下，我们都先用相同的信号来解决相关的逆问题。具体来说，我们提出了一个在凸形式之前的冗余分析信号。通过数值模拟，我们探索不同的现实设置。我们的目标也是强调一些实际的指导方针，并讨论它们的复杂性权衡，以将这些方案整合到实际的计算成像系统中。我们的结论是，第二种技术在高压缩水平下表现最好，尺寸和校准尺寸都合适。否则，首先，更简单的技术应该受到青睐。

##### URL
[http://arxiv.org/abs/1802.02040](http://arxiv.org/abs/1802.02040)

##### PDF
[http://arxiv.org/pdf/1802.02040](http://arxiv.org/pdf/1802.02040)
