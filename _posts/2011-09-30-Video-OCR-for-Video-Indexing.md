...
categories: arXiv_CV
tags: arXiv_CV OCR Video_Indexing Caption Recognition
...
视频OCR是一种通过自动提取和阅读字幕和注释可以极大地帮助定位视频中感兴趣的主题的技术。视频中的文本可以提供关键的索引信息。认识到这样的搜索应用文本是至关重要的。视频字符识别的主要难题是降级和变形字符，低分辨率字符或非常复杂的背景。为了解决这个问题，预处理文本图像起着至关重要的作用。大多数OCR引擎正在处理二进制图像，以便找到更好的图像二值化过程以获得期望的结果是非常重要的。准确的二值化过程将视频OCR的错误率降到最低。
