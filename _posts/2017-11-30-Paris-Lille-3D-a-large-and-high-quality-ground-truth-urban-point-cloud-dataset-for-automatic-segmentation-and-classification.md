...
本文介绍了一种新的移动激光扫描（MLS）获取的城市点云自动分割分类数据集。我们描述如何从采集到后处理和标签获得数据集。这个数据集可以用来学习分类算法，但是，由于对不同对象之间的分割给予了很大的关注，这个数据集也可以用来学习分割。该数据集由2个城市获取的2km左右的MLS点云组成。课程的数量和范围使我们认为它可以用来训练深度学习方法。此外，我们还展示了一些自动分割和分类的结果。数据集可以在这个http URL中找到

##### URL
[https://arxiv.org/abs/1712.00032](https://arxiv.org/abs/1712.00032)

##### PDF
[https://arxiv.org/pdf/1712.00032](https://arxiv.org/pdf/1712.00032)
