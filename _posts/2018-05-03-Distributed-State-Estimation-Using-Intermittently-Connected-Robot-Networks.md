...
date: 2018-05-03 23:28:22
categories: arXiv_RO
tags: arXiv_RO Knowledge
author: Reza Khodayi-mehr, Yiannis Kantaros, Michael M. Zavlanos
mathjax: true
---
...
本文考虑使用多机器人系统进行分布式状态估计的问题。机器人的通信能力有限，因此只能在物理距离很近的情况下间歇性地进行测量。为了减少机器人只需要通过的距离，我们将它们分成小团队，可以在不同的地点进行交流，以共享信息并更新他们的信仰。然后，我们提出了一种新的分布式方案，该方案结合（i）确保网络间歇性连接的通信时间表，以及（ii）每个团队中机器人的基于采样的运动计划，目的是收集最佳测量结果并确定位置为那些机器人进行沟通。就我们所知，这是第一个分布式状态估计框架，它放宽了所有网络连接性假设，并控制间歇性通信事件，从而使估计不确定性最小化。我们提出的仿真结果表明，与始终保持端到端连接网络的方法相比，估计精度显着提高。

##### URL
[http://arxiv.org/abs/1805.01574](http://arxiv.org/abs/1805.01574)

##### PDF
[http://arxiv.org/pdf/1805.01574](http://arxiv.org/pdf/1805.01574)
