---
layout: post
title: "Markov Logic Networks with Statistical Quantifiers"
date: 2018-07-03 13:39:19
categories: arXiv_AI
...
马尔可夫逻辑网络（MLN）非常适合表达统计数据，例如“吸烟者很有可能知道另一个吸烟者”，但不能表达诸如“有吸烟者知道大多数其他吸烟者”的陈述，这对于建模是必要的，例如社交网络中的影响者。为了克服这个缺点，我们研究了量化的MLN，它通过引入统计通用量词来推广MLN，允许以原则方式表达后一类统计量。我们的主要技术贡献是表明量化MLN中的标准推理任务，最大后验和边际推断，可以在多项式时间内减少到它们各自的MLN对应物。

##### URL
[http://arxiv.org/abs/1807.01183](http://arxiv.org/abs/1807.01183)

##### PDF
[http://arxiv.org/pdf/1807.01183](http://arxiv.org/pdf/1807.01183)
