...
date: 2017-04-15 17:18:11
categories: arXiv_CL
tags: arXiv_CL Language_Model SLAM Relation
...
在本文中，我们提出了一种基于Rao-Blackwellized粒子滤波器的在线学习算法，用于空间概念的获取和映射。我们提出了非参数贝叶斯空间概念获取模型（SpCoA）。我们提出了一种将SpCoA和FastSLAM集成在贝叶斯生成模型的理论框架中的新方法（SpCoSLAM）。所提出的方法可以同时学习地点类别和词典，同时递增地产生环境地图。此外，该方法具有场景图像特征和语言模型添加到SpCoA。在实验中，我们在机器人没有地图的新环境中测试空间概念和环境地图的在线学习。然后，我们评估空间概念的在线学习和词汇习得的结果。实验结果表明，该机器人能够更准确地通过使用所提出的方法来学习单词和环境地图中的位置之间的关系。

##### URL
[https://arxiv.org/abs/1704.04664](https://arxiv.org/abs/1704.04664)

##### PDF
[https://arxiv.org/pdf/1704.04664](https://arxiv.org/pdf/1704.04664)
