...
在本文中，我们使用来自多个视图的2D对象检测来同时估计每个对象的3D二次曲面并定位摄像机位置。我们推导出一种SLAM公式，它使用双重二次曲面作为3D地标表示，利用它们紧凑地表示对象的大小，位置和方向的能力，并展示2D对象检测如何通过新颖的几何误差公式直接约束二次参数。我们开发了一种用于物体探测器的传感器模型，用于解决部分可见物体的挑战，并演示了如何使用普通透视相机在基于因子图的SLAM中联合估计相机姿态和约束双二次参数。

##### URL
[http://arxiv.org/abs/1804.04011](http://arxiv.org/abs/1804.04011)

##### PDF
[http://arxiv.org/pdf/1804.04011](http://arxiv.org/pdf/1804.04011)
