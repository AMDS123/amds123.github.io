---
layout: post
title: "REGMAPR - A Recipe for Textual Matching"
date: 2018-08-13 17:38:54
categories: arXiv_AI
tags: arXiv_AI Regularization Embedding Detection
...
我们提出了一个简单的文本匹配问题模型。从暹罗建筑开始，我们根据正在考虑的两个句子中的单词之间的精确和复述匹配来增加具有两个特征的单词嵌入。我们在数据集上使用四种类型的正则化来训练模型，用于文本蕴涵，释义检测和语义相关性。我们的模型比更复杂的架构表现得更好或更好;在SICK数据集上实现复述检测的最新结果，并在SNLI数据集上实现文本蕴涵。

##### URL
[http://arxiv.org/abs/1808.04343](http://arxiv.org/abs/1808.04343)

##### PDF
[http://arxiv.org/pdf/1808.04343](http://arxiv.org/pdf/1808.04343)
