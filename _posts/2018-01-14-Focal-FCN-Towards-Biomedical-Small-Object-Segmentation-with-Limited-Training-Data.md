---
layout: post
title: "Focal FCN: Towards Biomedical Small Object Segmentation with Limited Training Data"
date: 2018-01-14 19:29:55
categories: arXiv_CV
tags: arXiv_CV Segmentation Deep_Learning
author: Xiao-Yun Zhou, Mali Shen, Celia Riga, Guang-Zhong Yang, Su-Lin Lee
mathjax: true
---
...
小物体分割是医学图像分析中的常见任务。传统的基于特征的方法需要人为干预，而基于深度学习的方法自动训练神经网络。然而，对小物体应用深度学习方法仍然是错误的。本文提出了一种基于有限训练数据的小目标分割方法。首先，提出了完全加权的FCN，通过对背景和前景损失加权来对Focal FCN应用初始化。其次，利用焦点损失使训练集中在错误分类的像素上，从而在小物体分割上取得良好效果。 FCN，加权FCN，完全加权FCN和局灶性FCN的比较在定制的覆膜支架标记物分割上进行测试。
