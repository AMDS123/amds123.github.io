---
layout: post
title: "Nihar Talele and Katie Byl"
date: 2018-07-26 00:40:39
categories: arXiv_RO
tags: arXiv_RO Optimization
author: Toward Efficient, Robust Biped Walking Optimization
mathjax: true
---
...
实用的双足机器人运动需要既节能又对变异性和不确定性具有鲁棒性。在本文中，我们基于最近的机器人运动轨迹优化工作，有两个主要目标。首先，我们希望证明以下重要性：（a）不仅要考虑和量化能量效率，还要考虑步态的稳健性，以及（b）不仅要优化标称运动轨迹，还要优化机器人设计参数和反馈控制策略。作为第二个补充焦点，我们提出了关于5连杆平面行走模型的优化研究的结果，以提供关于特定权衡的初步数据以及提高效率与稳健性的一般趋势。在解决重要的，开放的挑战时，我们特别关注选择效果的讨论（a）在选择绩效指标时总是，必然只是近似优化，以及（b）在构建和调整反馈控制时。

##### URL
[http://arxiv.org/abs/1807.09905](http://arxiv.org/abs/1807.09905)

##### PDF
[http://arxiv.org/pdf/1807.09905](http://arxiv.org/pdf/1807.09905)
