...
在本文中，我们提出了一个多模式搜索引擎的室内设计，结合视觉和文字查询。我们的引擎的目标是检索内部对象，例如家具或挂钟，与查询分享视觉和美学的相似之处。我们的搜索引擎允许用户拍摄一个房间的照片，并以高回忆的方式检索与照片中相同或者视觉上相似的项目列表。此外，它允许返回美学和风格上适合在一起的其他项目。为了实现这一目标，我们的系统将使用文本和视觉模式获得的结果进行混合。得益于这种混合策略，我们将检索到的项目的平均样式相似度分数提高了11％。我们的工作是作为一个基于网络的应用程序来实施的，计划向公众开放。

##### URL
[https://arxiv.org/abs/1707.06907](https://arxiv.org/abs/1707.06907)

##### PDF
[https://arxiv.org/pdf/1707.06907](https://arxiv.org/pdf/1707.06907)
