...
我们提出了一个统一的音频恢复问题的建模和算法框架。它包括分析稀疏先验以及更经典的合成稀疏先验，稀疏规则以及收缩算子体现的各种形式的稀疏性（如社会收缩）。该框架的多功能性在两个恢复场景中进行了说明：去噪和去除。对这些情景的广泛的实验结果，既突出了稀疏分析所提供的20％甚至更多的加速度，又突出了社交味道和朴素味道都可以实现的大幅下降的质量。虽然这两种口味总体表现出类似的表现，但其详细的比较显示出不同的趋势，取决于是否考虑了翻转或去噪。
