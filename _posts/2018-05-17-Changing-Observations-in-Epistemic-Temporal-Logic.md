...
我们研究知识和时间逻辑中的主体观察力的动态变化。我们考虑CTL * K，即CTL *与知识操作员的延伸，并用一个新的操作员来丰富它，这个操作员模拟了代理人观察系统的方式的变化。我们扩展了完美召回代理的知识的经典语义以解释观察的变化，并且我们证明这个新的运算符严格地增加了CTL * K的表达性。我们将逻辑的模型检查问题减少到已知可判定的CTL * K问题。这为我们的逻辑模型检查问题提供了一个解决方案，但其复杂性并不是最优的。事实上，我们提供了一个更复杂的直接决策程序。

##### URL
[http://arxiv.org/abs/1805.06881](http://arxiv.org/abs/1805.06881)

##### PDF
[http://arxiv.org/pdf/1805.06881](http://arxiv.org/pdf/1805.06881)
