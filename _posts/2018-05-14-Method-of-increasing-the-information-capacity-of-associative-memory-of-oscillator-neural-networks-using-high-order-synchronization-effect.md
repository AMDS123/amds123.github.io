...
date: 2018-05-14 13:45:08
categories: arXiv_CV
tags: arXiv_CV Recognition
author: Andrei Velichko, Maksim Belyaev, Vadim Putrolaynen, Petr Boriskov
mathjax: true
---
...
使用热耦合$ VO_2 $ -witch的两振荡器和三振荡器方案的计算建模用于演示基于高阶同步效应的脉冲振荡器神经网络（ONN）中的模式存储和识别的新方法。该方法确保了关联存储器的高信息容量，即大量同步状态$ N_s $。系统中的每个状态的特征在于同步顺序被确定为公共同步频率处的谐波数的比率。该建模表明，对于三振荡器方案$ N_s $ ~650和双振荡器方案$ N_s $ ~260，可获得几个订单的$ N_s $。获得了许多规律性，特别是当$ N_s $具有最大值时，揭示了振荡器耦合的最佳强度。当耦合强度和开关内部噪声幅度增加时，示出了信息容量减小的一般趋势。提出了一种模式存储和测试向量识别算法。还示出了每个矢量中的坐标数应该比开关数小1，以减少识别模糊。所展示的关联存储器实现方法是一般的，并且可以应用于具有各种机制和振荡器耦合拓扑的ONN。

##### URL
[https://arxiv.org/abs/1805.08737](https://arxiv.org/abs/1805.08737)

##### PDF
[https://arxiv.org/pdf/1805.08737](https://arxiv.org/pdf/1805.08737)
