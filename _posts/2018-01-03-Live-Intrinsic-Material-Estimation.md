---
layout: post
title: "Live Intrinsic Material Estimation"
date: 2018-01-03 16:55:31
categories: arXiv_CV
tags: arXiv_CV Segmentation Face CNN Quantitative
author: Abhimitra Meka, Maxim Maximov, Michael Zollhoefer, Avishek Chatterjee, Christian Richardt, Christian Theobalt
mathjax: true
---
...
我们提出了第一个端对端的方法来实现一般物体形状的实时材料估计，只需要一个彩色图像作为输入。除了朗伯表面属性，我们的方法完全自动计算镜面反射率，材质的光泽和前景分割。我们利用基于深卷积编码器 - 解码器体系结构的图像到图像转换技术的最新进展来处理这个具有挑战性和不适当的反演渲染问题。我们的方法的基本核心代表是镜面阴影，漫反射阴影和镜像，从而可以学习漫反射和镜面反射率的有效准确分离。此外，我们提出了一种新颖的高效感知渲染损失模仿真实世界的图像形成，并获得即使在运行时的中间结果。以实时帧速率估算材料参数可实现激动人心的混合现实应用，例如将虚拟对象无缝照明一致集成到真实场景中，以及虚拟材料克隆。我们在现场设置中展示我们的方法，将其与现有技术进行比较，并通过定量和定性评估来激发其效果。

##### URL
[http://arxiv.org/abs/1801.01075](http://arxiv.org/abs/1801.01075)

##### PDF
[http://arxiv.org/pdf/1801.01075](http://arxiv.org/pdf/1801.01075)
