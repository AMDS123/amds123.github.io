...
我们在抽象论证框架（AF）中研究不变冲和自由集合的不变局部扩展算子。这些运算符直接应用于AF，并且对于所选择的“语义”（即w.r.t.每个无冲突/可接受的参数集）都是不变的。因此，我们根据可以应用这些运算符的次数得出AF的鲁棒性的定义，而不会在所选择的语义中产生任何变化。

##### URL
[http://arxiv.org/abs/1802.08328](http://arxiv.org/abs/1802.08328)

##### PDF
[http://arxiv.org/pdf/1802.08328](http://arxiv.org/pdf/1802.08328)
