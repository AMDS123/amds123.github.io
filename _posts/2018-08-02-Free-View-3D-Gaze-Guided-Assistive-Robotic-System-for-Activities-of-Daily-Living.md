...
date: 2018-08-02 17:21:47
categories: arXiv_RO
tags: arXiv_RO Face Recognition
author: Ming-Yao Wang, Alexandros A. Kogkas, Ara Darzi, George P. Mylonas
mathjax: true
---
...
患有四肢瘫痪的患者身体运动受限，这阻碍了他们进行日常活动。我们开发了一种具有直观自由视野凝视界面的辅助机器人系统。用户的关注点在3D空间中估计，同时允许自由头部移动并且与对象识别和轨迹规划相结合。该框架允许用户使用注视与对象进行交互。已实施两种运作模式以迎合不同的可能性。自动模式执行与凝视选择的对象相关联的预定义任务，而手动模式允许凝视控制机器人的末端执行器位置在用户的参照系上。用户研究报告在自动模式下轻松操作。用户首次尝试时，手动拾取和放置任务成功率达到100％。

##### URL
[http://arxiv.org/abs/1807.05452](http://arxiv.org/abs/1807.05452)

##### PDF
[http://arxiv.org/pdf/1807.05452](http://arxiv.org/pdf/1807.05452)
