...
本文提出了一种新颖的视觉惯性测距方法。该方法基于采用低成本IMU传感器和标准智能手机中的单眼相机的信息融合框架。我们制定了一个顺序推理方案，其中IMU驱动动力学模型，相机帧被用于耦合拖尾序列的增强姿势。模型中的新颖性是考虑到更新中的所有交叉项，从而在整个模型中传播相互关联的不确定性。惯性和可视数据源之间更紧密的耦合导致了对阻塞和功能差的环境的稳健性。我们演示使用iPhone收集的数据的结果，并与Tango设备进行比较，并使用EuRoC数据集。

##### URL
[http://arxiv.org/abs/1708.00894](http://arxiv.org/abs/1708.00894)

##### PDF
[http://arxiv.org/pdf/1708.00894](http://arxiv.org/pdf/1708.00894)
