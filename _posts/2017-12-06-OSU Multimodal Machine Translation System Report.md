...
本文描述了俄勒冈州立大学提交共同WMT'17任务“多模式翻译任务I”。在这个任务中，所有的句子对都是不同语言的图片标题。这个任务与传统机器翻译的主要区别在于，我们有相应的图像作为每个句子对的附加信息。在本文中，我们介绍一个简单而有效的系统，它将不同语言之间共享的图像分享给编码和解码端。我们用Flickr30K（in-domain）和MSCOCO（out-of-domain）数据集来报告我们的英文 - 法文和英文 - 德文的系统性能。对于MSCOCO数据集，我们的系统在英文 - 德文的TER中达到了最好的性能。
