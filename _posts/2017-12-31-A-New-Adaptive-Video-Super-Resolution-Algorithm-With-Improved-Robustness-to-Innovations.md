...
本文提出了一种新的视频超分辨率重构（robust super-resolution reconstruction，SRR）方法。尽管R-LMS是SRR算法之一，其计算代价具有最好的重构质量，并且对于配准误差自然是强健的，但是其性能在存在创新异常值的情况下会严重降级。通过研究R-LMS迭代方程的近点代价函数表示，可以更好地理解不同情况下的性能。利用典型创新异常值的统计特性，提出了一种新的代价函数，并推导了两种新的算法，在保持与R-LMS相当的计算成本的同时，提高了异常值的鲁棒性。蒙特卡洛仿真结果表明，所提出的方法优于传统和正则化版本的LMS，并且与现有技术的SRR方法相比具有竞争性，而且计算成本更低。

##### URL
[http://arxiv.org/abs/1706.04695](http://arxiv.org/abs/1706.04695)

##### PDF
[http://arxiv.org/pdf/1706.04695](http://arxiv.org/pdf/1706.04695)
