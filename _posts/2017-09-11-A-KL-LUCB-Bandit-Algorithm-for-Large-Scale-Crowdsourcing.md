...
本文重点研究多武装匪徒获得有限奖励的最佳武器识别。我们开发了一种lil-UCB和KL-LUCB融合的算法，在一种方法中提供了两种算法的最佳质量。这是通过证明一个新的随机置信区间的有界分布的平均值来实现的，这是近来为亚高斯分布开发的LIL类边界的类似物。我们通过基于纽约客漫画字幕竞赛的数值实验来证实我们的理论结果。
