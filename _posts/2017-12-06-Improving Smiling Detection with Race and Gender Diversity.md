...
最近在深度学习方面取得的进展伴随着人们越来越关注模型是否对用户公平，在不同的人口统计方面表现同样好。在计算机视觉研究中，这些问题与人脸检测以及人脸属性检测的相关任务等有关。我们在微笑检测的背景下衡量种族和性别包容，并介绍一种改善人口群体微笑检测的方法。我们的方法在现有的检测方法上引入了一些修改，利用双重转移学习来更好地模拟面部多样性。结果表明，这种技术提高了大多数人口群体以及整体的强基线的准确性。我们表现​​最好的模式为微笑检测定义了一个新的最新技术，在世界面孔数据集中达到了91％。伴随的多头多样性分类器还为性别分类定义了一个新的最新技术，在世界数据集的脸上达到了93.87％。这项研究表明了种族和性别建模的效用，以改善一个人脸属性检测任务，使用双重转移学习框架，允许隐私个人目标数据集。
