...
date: 2018-02-14 05:36:14
categories: arXiv_CV
tags: arXiv_CV Caption Optimization Classification
...
人类行为理解可以说是人工智能中最重要的中层组成部分之一。为了有效地利用数据，已经在包括人类行为理解在内的各种计算机视觉任务中研究了多任务学习。然而，多任务学习依赖于任务特定的数据集，并且构建这样的数据集可能是麻烦的。它需要大量的数据，标签工作，统计考虑等。在本文中，我们利用现有的单任务数据集进行人类行为分类和字幕数据，以实现有效的人类行为学习。由于每个数据集中的数据具有各自的异构注释，因此传统的多任务学习在这种情况下无效。为此，我们提出了一种新颖的交替方向优化方法，以有效地从异构数据中学习。我们展示了模型的有效性，并且与在每个单任务数据集上训练的模型相比，显示了分类和句子检索任务的性能改进。

##### URL
[https://arxiv.org/abs/1802.04962](https://arxiv.org/abs/1802.04962)

##### PDF
[https://arxiv.org/pdf/1802.04962](https://arxiv.org/pdf/1802.04962)
