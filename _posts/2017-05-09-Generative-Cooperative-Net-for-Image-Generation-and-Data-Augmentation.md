...
如何给抽象概念建立一个良好的图像生成模型是计算机视觉中的一个基本问题。在本文中，我们探索了一个生成具有所需特征的未见图像的生成模型。我们提出用于图像生成的生成合作网（GCN）。这个想法类似于生成对抗网络，除了生成器和鉴别器被训练来相应地工作。我们在手写数字生成和面部表情生成方面的实验表明，GCN的两个合作对象（生成器和分类器）可以很好地协同工作并取得令人满意的结果。我们还发现了这种生成模型作为数据增强工具的用法。我们将这种方法应用于识别任务的实验表明，与其他现有方法相比，它是非常有效的。这很容易建立，并可以帮助生成一个非常大的合成数据集。

##### URL
[https://arxiv.org/abs/1705.02887](https://arxiv.org/abs/1705.02887)

##### PDF
[https://arxiv.org/pdf/1705.02887](https://arxiv.org/pdf/1705.02887)
