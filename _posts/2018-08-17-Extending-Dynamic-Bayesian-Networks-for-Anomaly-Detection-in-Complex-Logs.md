...
检查来自不同进程的各种日志文件可能是一项繁琐的任务，因为这些日志包含大量事件，每个事件都具有（可能很大）数量的属性。我们开发了一种自动建模日志文件并检测数据中异常值跟踪的方法。为此，我们扩展了动态贝叶斯网络，以模拟日志文件中的正常行为。我们引入了一种新算法，它能够从数据本身开始学习日志文件的模型。即使新值或新值组合出现在日志文件中，该模型也能够对跟踪进行评分。

##### URL
[http://arxiv.org/abs/1805.07107](http://arxiv.org/abs/1805.07107)

##### PDF
[http://arxiv.org/pdf/1805.07107](http://arxiv.org/pdf/1805.07107)
