...
本文提出了视觉问答（VQA）的最新模型，该模型在2017年VQA挑战赛中获得第一名。 VQA对于人工智能研究具有重要的意义，因为它具有多模式性质，明确的评估协议和潜在的实际应用。深度神经网络对于VQA的性能非常依赖于架构和超参数的选择。为了帮助进一步研究该领域，我们详细描述了我们的高性能，虽然相对简单的模型。通过大量的体系结构和超过3,000 GPU时间的超参数的探索，我们发现了一些可以使其成功的技巧和诀窍，即：S形输出，软训练目标，自下而上注意力的图像特征，门控激励，输出嵌入使用GloVe和Google Images进行初始化，大型小批量，以及训练数据的智能混洗。我们详细分析了他们对绩效的影响，以帮助他人做出适当的选择。
