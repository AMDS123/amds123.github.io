...
语音分离是将目标语音与背景干扰分开的任务。传统上，语音分离作为信号处理问题被研究。更近期的方法将语音分离制定为监督学习问题，其中从训练数据中学习语音的区别模式，讲话者和背景噪声。在过去的十年中，提出了许多有监督的分离算法。特别是最近引入的深度学习监督语音分离，大大加快了进度，提高了分离性能。本文综述了近几年来基于深度学习的有监督语音分离的研究情况。我们首先介绍语音分离的背景和监督分离的制定。然后讨论监督分离的三个主要组成部分：学习机器，训练目标和声学特征。大部分概述是关于分离算法，我们在其中回顾单声道方法，包括语音增强（语音非语音分离），说话者分离（多说话者分离）和语音去混响，以及多麦克风技术。讨论了监督学习所特有的泛化的重要问题。本概览提供了如何取得进展的历史观点。另外，我们讨论了一些概念问题，包括什么是目标来源。

##### URL
[https://arxiv.org/abs/1708.07524](https://arxiv.org/abs/1708.07524)

##### PDF
[https://arxiv.org/pdf/1708.07524](https://arxiv.org/pdf/1708.07524)
