...
图像分割是根据一些标准将图像分割成一组有意义的区域的过程。分层分割已成为这方面的主要趋势，因为它有利于不同规模重要地区的出现。另一方面，许多方法使我们能够获得有关图像中感兴趣结构位置的先验信息。在本文中，我们提出了一种多功能的分层分割方法，该方法考虑到任何先前的空间信息并输出强调感兴趣的轮廓或区域的层次分割，同时保留图像中的重要结构。提出了该方法在弱监督分割问题中的应用。

##### URL
[http://arxiv.org/abs/1802.07008](http://arxiv.org/abs/1802.07008)

##### PDF
[http://arxiv.org/pdf/1802.07008](http://arxiv.org/pdf/1802.07008)
