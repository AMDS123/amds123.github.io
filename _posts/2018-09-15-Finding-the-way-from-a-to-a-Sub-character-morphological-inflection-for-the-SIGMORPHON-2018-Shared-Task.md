...
date: 2018-09-15 16:42:24
categories: arXiv_CL
tags: arXiv_CL
author: Fynn Schr&#xf6;der, Marcel Kamlot, Gregor Billing, Arne K&#xf6;hn
mathjax: true
---
...
在本文中，我们描述了UHH提交给CoNLL  -  SIGMORPHON 2018共享任务：通用形态学反射的系统。我们提出了一种基于UZH概念的神经结构（Makarov et al。，2017），为其关键概念添加了新的思想和技术，并评估了不同的参数组合。生成的系统是一种与语言无关的网络模型，旨在通过在单个字符的图形特征上引入等价类来减少学习编辑操作的数量。我们试图通过比较不同的网络配置和评估我们在各种语言上的结果来确定这种方法的优缺点。

##### URL
[http://arxiv.org/abs/1809.05742](http://arxiv.org/abs/1809.05742)

##### PDF
[http://arxiv.org/pdf/1809.05742](http://arxiv.org/pdf/1809.05742)
