...
我们致力于从丰富资源语言到低资源语言的翻译。我们确定的主要挑战是缺乏低资源语言数据，跨语言传输的有效方法以及神经系统中常见的变量绑定问题。我们建立了一个翻译系统，以八个欧洲语言家庭作为测试场地来应对这些挑战。首先，我们添加源和目标家庭标签，并研究家庭内和家庭间的影响，以实现有效的跨语言转移。与单户多源多目标NMT基线相比，我们实现了+8.4 BLEU评分的提高。我们发现培训两个最靠近低资源语言的邻居往往是足够的。其次，我们构建一个消融研究，发现即使目标数据少得多，也可以获得相当好的结果。第三，我们通过构建保序命名实体翻译模型来解决变量绑定问题。我们在定性评估中获得了60.6％的准确性，其中我们的翻译类似于初步研究中的人工翻译。

##### URL
[https://arxiv.org/abs/1804.07878](https://arxiv.org/abs/1804.07878)

##### PDF
[https://arxiv.org/pdf/1804.07878](https://arxiv.org/pdf/1804.07878)
