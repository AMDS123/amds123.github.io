...
categories: arXiv_CV
tags: arXiv_CV Image_Caption Knowledge GAN Caption Recognition
...
为了在有限的空间中传达最多的内容，广告通过象征主义来嵌入对外部知识的引用。例如，一辆摩托车代表冒险（广告希望与销售的产品相关的积极财产），枪支代表危险（一种负面的性质来阻止观众不受欢迎的行为）。我们展示了如何使用符号引用来更好地理解广告的含义。我们进一步展示如何将广告理解锚定在通用对象识别和图像字幕中可以进一步改善结果。我们制定了广告理解任务，将广告图像与描述广告提示行为的人为生成语句以及为此操作提供的基本原理相匹配。在这项工作中，我们的表现大大超过了艺术水平。我们还展示了我们的学习表示的额外应用程序，用于对广告口号进行排名，并根据他们的主题对广告进行聚类。
