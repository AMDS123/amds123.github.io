...
本文介绍了一种可以准确检测室内场景下头部特别是小头部的方法。为此，我们提出了一种新颖的方法，特征细化网（FRN）和级联多尺度架构。 FRN利用深度卷积神经网络创建的多尺度分层特征。所提出的信道加权方法使得FRN能够交替和有效地利用特征。为了提高小磁头检测的性能，我们提出了一种具有两个检测器的级联多尺度结构。一个被称为全局探测器的负责探测大型物体并获取全球分布信息。另一种称为本地检测器的设计用于小物体检测，并利用全局检测器提供的信息。由于缺乏头部检测数据集，我们收集并贴上了一个名为SCUT-HEAD的新大型数据集，其中包含4405个带有111251个头部注释的图像。实验表明，我们的方法在SCUT-HEAD上实现了最先进的性能。

##### URL
[http://arxiv.org/abs/1803.09256](http://arxiv.org/abs/1803.09256)

##### PDF
[http://arxiv.org/pdf/1803.09256](http://arxiv.org/pdf/1803.09256)
