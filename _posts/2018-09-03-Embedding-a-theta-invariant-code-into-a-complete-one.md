---
layout: post
title: "Embedding a $theta$-invariant code into a complete one"
date: 2018-09-03 09:10:32
categories: arXiv_CL
tags: arXiv_CL Embedding
author: Jean N&#xe9;raud (LITIS, UNIROUEN), Carla Selmi (LITIS, UNIROUEN)
mathjax: true
---
...
设A是一个有限的或可数的字母表，让$ \ theta $成为A *的文字（反）自同构（根据定义，这种对应关系是由字母表的排列决定的）。本文论述了在$ \ theta $（$ \ theta $ -invariant）下不变的集合，即语言L使得$ \ theta $（L）是L的子集。我们建立了着名的扩展缺陷定理。关于所谓的完整性概念，我们提供了一系列有限完整$ \ theta $ -invariant代码的例子。此外，我们建立了一个公式，允许将任何非完整的$ \ theta $ -invariant代码嵌入到完整的代码中。因此，在所谓的瘦$ \ theta $  - 不变代码的族中，最大性和完整性是两个等价的概念。

##### URL
[http://arxiv.org/abs/1801.05164](http://arxiv.org/abs/1801.05164)

##### PDF
[http://arxiv.org/pdf/1801.05164](http://arxiv.org/pdf/1801.05164)
