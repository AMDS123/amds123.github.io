...
自动驾驶汽车今天面临的主要挑战之一是在城市环境中驾驶。为了使其成为现实，自动驾驶汽车需要与其他道路使用者沟通并了解他们的意图的能力。作为最弱势的道路使用者，车辆和行人之间的这种相互作用至关重要。然而，理解行人行为并不直观，并取决于各种因素，如行人的人口特征，交通动态，环境条件等。本文中，我们通过调查行人行为研究来确定这些因素，包括关于行人 - 驾驶员互动和涉及自动驾驶汽车的现代汽车。为此，我们将讨论研究行人行为的各种方法，并分析文献中确定的因素是如何相互关联的。我们还将回顾旨在解决交互问题的实际应用，包括与行人通信的自主车辆的设计方法以及为了解行人意图而量身定制的视觉感知和推理算法。根据我们的研究结果，我们将讨论开放性问题并提出未来的研究方向。

##### URL
[https://arxiv.org/abs/1805.11773](https://arxiv.org/abs/1805.11773)

##### PDF
[https://arxiv.org/pdf/1805.11773](https://arxiv.org/pdf/1805.11773)
