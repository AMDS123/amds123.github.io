...
date: 2018-09-17 08:17:49
categories: arXiv_RO
tags: arXiv_RO Optimization
author: Xunhua Dai, Quan Quan, Jinrui Ren, Kai-Yuan Cai
mathjax: true
---
...
Multicopters在民用和军用领域变得越来越重要。目前，大多数多旋翼飞行器推进系统是通过经验和反复试验设计的，这些实验成本高且效率低。本文提出了一种简单实用的方法，帮助设计人员根据给定的设计要求找到最优的推进系统。首先，分别研究了推进系统的四个基本部件的建模方法，包括螺旋桨，电动机，电动速度控制和电池。其次，整个优化设计问题被简化并解耦为几个子问题。通过解决这些子问题，可以分别获得每个组件的最佳参数。最后，基于所获得的最佳组件参数，可以从相应的数据库快速定位和确定每个组件的最佳产品。实验和统计分析证明了所提方法的有效性。

##### URL
[http://arxiv.org/abs/1809.02472](http://arxiv.org/abs/1809.02472)

##### PDF
[http://arxiv.org/pdf/1809.02472](http://arxiv.org/pdf/1809.02472)
