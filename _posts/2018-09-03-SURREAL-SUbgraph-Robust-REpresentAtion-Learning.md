---
layout: post
title: "SURREAL: SUbgraph Robust REpresentAtion Learning"
date: 2018-09-03 04:17:46
categories: arXiv_AI
tags: arXiv_AI Embedding Represenation_Learning Classification Prediction Recommendation
...
图形嵌入或节点表示学习在各种下游任务中的成功，例如节点分类，链接预测和推荐系统，近年来已经普及。表示学习算法旨在通过识别节点邻域概念来保持本地和全局网络结构。然而，许多现有算法生成嵌入，这些嵌入不能正确地保留网络结构，或者由于随机过程（例如，随机遍历以生成上下文）而导致不稳定的表示，并且因此不能生成到多图问题。在本文中，我们提出了RECS，一种新颖的，稳定的图嵌入算法框架。 RECS通过使用带有电路的图形的类比，使用连接子图来学习图形表示。它保留了本地和全局连接模式，并解决了高度节点的问题。此外，它利用了基线忽略的弱关系和元数据的优势。实验表明，RECS在多标签分类问题上的表现优于最先进的算法高达36.85％。此外，与基线相比，RECS是确定性的，是完全稳定的。

##### URL
[http://arxiv.org/abs/1805.01509](http://arxiv.org/abs/1805.01509)

##### PDF
[http://arxiv.org/pdf/1805.01509](http://arxiv.org/pdf/1805.01509)
