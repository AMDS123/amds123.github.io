...
生成对抗网络（GAN）最近在图像生成方面显示了很大的希望。用于语言生成的训练GAN已经被证明是更困难的，因为用循环神经网络生成文本的不可区分性。因此，过去的工作要么采用最大似然的预训练，要么采用卷积网络来生成。在这项工作中，我们表明，循环神经网络可以被训练，从头开始使用课程学习，从头开始生成文本，通过慢慢地教学模型生成增加和变长的序列。我们凭经验证明，与卷积基线相比，我们的方法大大提高了生成序列的质量。

##### URL
[http://arxiv.org/abs/1706.01399](http://arxiv.org/abs/1706.01399)

##### PDF
[http://arxiv.org/pdf/1706.01399](http://arxiv.org/pdf/1706.01399)
