...
当前的机器人平台正被用来与人类在广泛的家庭和工业任务中进行协作。这些环境要求自治系统能够分类和通信异常的情况，如火灾，受伤的人，车祸;或者一般来说，任何人类潜在的危险情况。在本文中，我们介绍了一个用于机器人应用目的的异常检测数据集，以及一个深度学习体系结构的设计和实现，该体系结构仅使用单个图像作为输入对危险情况进行分类和描述。我们报告的分类准确率为97％，METEOR得分为16.2。在接受这篇论文后，我们会公布数据集。
