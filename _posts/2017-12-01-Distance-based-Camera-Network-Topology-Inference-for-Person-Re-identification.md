...
在本文中，我们提出了一种新颖的基于距离的摄像机网络拓扑推理方法，用于高效人员重新识别。为此，我们首先校准每个相机并估计相机之间的相对尺度。使用多台摄像机的校准结果，我们计算每个人的速度，并推断摄像机之间的距离，以生成基于距离的摄像机网络拓扑。所提出的基于距离的拓扑可以根据其速度自适应地应用于每个人，并且处理不重叠的摄像机之间的人的不同的转换时间。为了验证所提出的方法，我们使用开放式人重新识别数据集来测试所提出的方法，并将其与最先进的方法进行比较。实验结果表明，该方法对于不同人群过渡时间的大型摄像机网络中人重新识别是有效的。
