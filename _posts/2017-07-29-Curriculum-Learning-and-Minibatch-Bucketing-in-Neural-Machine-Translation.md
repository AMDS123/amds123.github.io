...
我们研究了句子对的特定顺序对神经机器翻译（NMT）的在线训练的影响。我们关注两种类型的排序：（1）确保每个小批次在某些方面包含类似的句子;（2）随着培训的进展逐渐包含一些句子类型（所谓的“课程学习”）。在我们的英语到捷克语的实验中，minibatches的内部同质性对训练没有影响，但是我们的一些“课程”在基线上略有改进。
