...
我们提出一种预测涉及多人的复杂人类活动视频的方法。直接像素级预测过于简单，无法处理复杂活动中的外观变化。因此，我们开发新颖的中间表示。提出了一种结构分层的时间模型来预测人体姿态和编码器 - 解码器卷积神经网络来呈现目标外观的体系结构。我们的分层模型通过采用动态的基于群组的交互机制来捕捉人与人之间的交互。接下来，我们的外观渲染网络通过使用完全卷积网络学习自适应外观滤波器来对目标的外观进行编码。最后，将这些滤波器放置在编码器 - 解码器神经网络中以完成渲染。我们证明，我们的模型可以生成优于最先进方法的视频，并且可以处理视频预测中复杂的人类活动场景。

##### URL
[http://arxiv.org/abs/1712.01955](http://arxiv.org/abs/1712.01955)

##### PDF
[http://arxiv.org/pdf/1712.01955](http://arxiv.org/pdf/1712.01955)
