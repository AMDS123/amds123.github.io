...
智能系统能准确诊断精神障碍患者，根据脑功能成像数据确定有效的治疗方法，具有很好的适用性，受到广泛关注。大多数以前的机器学习研究使用手工设计的功能，例如功能连接，这不能保持大脑区域之间的空间关系和每个区域中信号的时间分布的潜在有用信息。在这里我们提出一种基于递归卷积神经网络的新方法来自动学习4-D fMRI记录段的有用表示。我们的目标是利用功能性MRI电影（在全脑体素水平）的空间和时间信息来识别精神分裂症患者。

##### URL
[https://arxiv.org/abs/1712.00512](https://arxiv.org/abs/1712.00512)
