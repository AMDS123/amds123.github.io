...
在多回合对话中，自然语言理解模型可能由于对上下文信息的盲目性而导致明显的错误。为了结合对话历史，我们提出了一种具有扬声器敏感的双重记忆网络的神经架构，其根据说话者对话语进行不同的编码。这解决了系统可用信息的不同程度 - 系统只知道用户话语的表面形式，而具有系统输出的确切语义。我们对商业个人助理Microsoft Cortana的实际用户数据进行了实验。结果显示，相比于使用上下文信息的最先进的时隙标记模型，显着的性能改进。
