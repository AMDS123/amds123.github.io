---
layout: post
title: "Average Case Constant Factor Optimal Multi-Robot Path Planning in Well-Connected Environments"
date: 2017-12-26 03:36:36
categories: arXiv_RO
tags: arXiv_RO
author: Jingjin Yu
mathjax: true
...
在许多现实世界的应用中追求最佳多机器人路径规划的快速算法。然而，已知的方法通常不能同时保证良好的解决方案的最优性和快速的运行时间（例如多项式）。在这项工作中，我们开发了一个叫做SplitAndGroup（SAG）的低多项式运行时间算法，它解决了网格和类网格环境下的多机器人路径规划问题，并在平均情况下产生了恒定因子完整性最优解。也就是说，SAG是一种平均情况下的O（1） - 近似算法。 SAG计算具有亚线性完工时间的解，并且能够处理机器人密度极高的情况 - 在图论的设置中，该算法支持底层图的所有顶点都被机器人占用的情况。 SAG通过分而治之的技术和基于网络流向的机器人路由方法的仔细组合来达到其理想的性能。来自SAG的解决方案在较弱的意义上也是总距离最优性的常数因子近似。

##### URL
[http://arxiv.org/abs/1706.07255](http://arxiv.org/abs/1706.07255)

##### PDF
[http://arxiv.org/pdf/1706.07255](http://arxiv.org/pdf/1706.07255)
