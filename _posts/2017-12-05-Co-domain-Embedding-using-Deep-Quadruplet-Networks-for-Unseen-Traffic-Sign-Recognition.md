...
视觉识别方面的最新进展显示了大量监督数据的总体成功。然而，获取大型监督数据集往往是一个挑战。这对于智能交通应用也是如此，即交通标志识别。例如，用一个国家的数据进行培训的模型可能不容易推广到另一个没有太多数据的国家。当给出代表性的类模板时，我们提出了一个新的特征嵌入方案。交通标志，不像其他物体，有官方图像。我们使用来自实际和合成域的四重关系执行共域嵌入。我们的四联网络充分利用了不同领域样本间的显式配对相似关系。我们验证了我们的方法在三个数据集上进行了两次实验，涉及一次分类和特征泛化。结果表明，所提出的方法在看到和看不见的类别上都优于竞争方法。

##### URL
[http://arxiv.org/abs/1712.01907](http://arxiv.org/abs/1712.01907)

##### PDF
[http://arxiv.org/pdf/1712.01907](http://arxiv.org/pdf/1712.01907)
