---
layout: post
title: "Aspl{'u}nd's metric defined in the Logarithmic Image Processing framework for colour and multivariate images"
date: 2018-03-02 09:06:54
categories: arXiv_CV
tags: arXiv_CV
...
对于模式匹配而言，Aspl {u} nd's度量包含双面探测，即函数的over-graph和sub-graph是联合探测的，它先前已被定义为灰度图像使用对数图像处理（LIP）框架LIP是一个非线性模型，用于在图像之间执行操作，同时与人类视觉系统保持一致我们的贡献在于将Aspen公式的度量扩展到颜色和多变量使用LIP框架的图像。 Aspen公式对光照变化不敏感，我们提出了一种对噪声稳健的颜色变量。

##### URL
[http://arxiv.org/abs/1803.00764](http://arxiv.org/abs/1803.00764)

##### PDF
[http://arxiv.org/pdf/1803.00764](http://arxiv.org/pdf/1803.00764)
