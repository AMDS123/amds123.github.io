...
光度立体（photometric stereo）是一种寻求从在不同光源下照明的物体图像中重建物体的法向矢量的方法。虽然在某些情况下是有效的，但经典的光度立体依赖于漫反射表面模型，其不能处理具有复杂反射模式的物体，并且对图像中的非理想性敏感。在这项工作中，我们提出了一种新颖的光度立体方法，依靠字典学习来产生稳健的法向量重建。具体而言，我们开发了三种用于将词典学习应用于光度立体的配方。我们提出一个预处理步骤，利用字典学习去噪图像。我们还提出了一个模型，应用字典学习规则化和重建的经典朗伯反射模型下的图像的法向量。最后，我们推广后一种模型来显式建模非朗伯物体。我们通过对合成和真实基准数据集进行广泛的实验来调查所有三种方法，并观察与现有稳健的光度立体方法相比最先进的性能。

##### URL
[http://arxiv.org/abs/1710.08873](http://arxiv.org/abs/1710.08873)

##### PDF
[http://arxiv.org/pdf/1710.08873](http://arxiv.org/pdf/1710.08873)
