---
layout: post
title: "High efficiency deep-UV emission at 219 nm from ultrathin MBE GaN/AlN quantum heterostructures"
date: 2017-04-27 20:32:16
categories: arXiv_CV
tags: arXiv_CV GAN
author: SM Islam, Vladimir Protasenko, Kevin Lee, Sergei Rouvimov, Jai Verma, Huili (Grace)Xing, Debdeep Jena
mathjax: true
---
...
在半导体中低于250nm（〜5eV）的深紫外（UV）光发射传统上是从含铝的AlGaN合金量子阱获得的。这里显示的是嵌入在AlN矩阵中的高质量外延超薄二元GaN量子盘可以在219-235nm（〜5.7至5.3eV）的光谱范围内产生高效的光发射，远高于体积带隙（3.4eV）氮化镓。这些异质结构中的量子限制能量大于传统半导体的带隙，由于大的能带偏移而成为可能。这些MBE生长的极端量子限制GaN / AlN异质结构在短至219nm的波长处表现出高达40％的内部量子效率。这些观察结果与设计带间光学矩阵元件以控制这种新的二元量子盘有源区域中的光子发射方向的能力相比，合金AlGaN量子阱对应物提供了用于实现深UV发光二极管的独特优点，激光器。

##### URL
[https://arxiv.org/abs/1704.08737](https://arxiv.org/abs/1704.08737)

##### PDF
[https://arxiv.org/pdf/1704.08737](https://arxiv.org/pdf/1704.08737)
