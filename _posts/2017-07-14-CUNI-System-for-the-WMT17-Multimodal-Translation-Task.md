...
在本文中，我们描述了我们对WMT17多模式翻译任务的提交。对于任务1（多模式翻译），我们最好的评分系统是源图像标题与目标语言的纯文本神经翻译。该系统的主要特点是使用通过从平行语料库中选择相似的句子而获得的附加数据以及通过回译的数据合成。对于任务2（跨语言图像字幕），我们最好的提交系统生成一个英文标题，然后通过任务1中使用的最佳系统翻译。我们也呈现负面的结果，这是基于我们认为有潜力的想法改进，但没有证明在我们的特定设置是有用的。

##### URL
[https://arxiv.org/abs/1707.04550](https://arxiv.org/abs/1707.04550)

##### PDF
[https://arxiv.org/pdf/1707.04550](https://arxiv.org/pdf/1707.04550)
