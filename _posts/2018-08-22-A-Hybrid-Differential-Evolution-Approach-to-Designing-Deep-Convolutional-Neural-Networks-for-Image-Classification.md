...
卷积神经网络（CNN）已经证明了它们在图像分类方面的优越性，并且最近演化计算（EC）方法已经涌现以自动设计CNN的架构以节省手动设计CNN的繁琐工作。本文提出了一种新的混合差分进化（DE）算法，该算法采用新增的交叉算子来演化任意长度的CNN结构，称为DECNN。拟议的DECNN方法有三个新想法。首先，改进现有的有效编码方案以满足可变长度CNN架构;其次，针对可变长度DE开发了新的变异和交叉算子，以优化CNN的超参数;最后，引入新的第二个交叉以演进CNN架构的深度。所提出的算法在六个广泛使用的基准数据集上进行了测试，并将结果与​​12种最先进的方法进行了比较，这表明所提出的方法与最先进的算法具有很强的竞争力。此外，还将所提出的方法与使用具有类似编码策略IPPSO的粒子群优化的方法进行比较，并且所提出的DECNN在准确性方面优于IPPSO。

##### URL
[http://arxiv.org/abs/1808.06661](http://arxiv.org/abs/1808.06661)

##### PDF
[http://arxiv.org/pdf/1808.06661](http://arxiv.org/pdf/1808.06661)
