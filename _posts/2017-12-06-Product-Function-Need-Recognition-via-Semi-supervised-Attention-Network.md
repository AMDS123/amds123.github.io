...
在购买产品时，功能对客户至关重要。但是，客户对产品是否真的能满足其功能的需求还不清楚。此外，缺失的功能可能被制造商或销售商故意隐藏。因此，客户在购买产品之前需要花费相当长的时间，或者自行承担购买风险的风险。在本文中，我们首先确定一个密集的产品功能信息\ footnote {注释语料库可以在\ url {https://www.cs.uic.edu/~hxu/}}上找到一个新的QA语料库。然后，我们设计一个名为半监督注意网络（SAN）的神经网络来从问题中发现产品功能。该模型利用未标记的数据作为上下文信息来执行半监督序列标记。我们进行的实验表明，与广泛的基线相比，提取的函数具有较高的覆盖率和准确性。

##### URL
[http://arxiv.org/abs/1712.02186](http://arxiv.org/abs/1712.02186)

##### PDF
[http://arxiv.org/pdf/1712.02186](http://arxiv.org/pdf/1712.02186)
