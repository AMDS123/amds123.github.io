...
在这项工作中，我们设计和训练深度神经网络来预测AIII类中的一维四频绝缘子的拓扑不变量，其拓扑不变量是绕组数，而A类中的二维双频绝缘子的拓扑不变量是Chern数。给定动量空间中的哈密顿量作为输入，即使对于不变量超出训练数据集的哈密顿量，神经网络也可以预测两个类的拓扑不变量，精度接近或高于90％。尽管神经网络很复杂，但我们发现某些中间隐藏层的输出类似于AIII类模型的缠绕角或者A类模型的立体角（Berry曲率），这表明神经网络基本上捕获了数学拓扑不变量的公式。我们的工作证明了神经网络能够预测局部Hamiltonian作为唯一输入的复杂模型的拓扑不变量，并提供了一个例子，即使是深度神经网络也是可以理解的。

##### URL
[http://arxiv.org/abs/1805.10503](http://arxiv.org/abs/1805.10503)

##### PDF
[http://arxiv.org/pdf/1805.10503](http://arxiv.org/pdf/1805.10503)
