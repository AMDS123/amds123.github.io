...
date: 2017-06-08 20:33:00
categories: arXiv_CL
tags: arXiv_CL Face Reinforcement_Learning Action_Recognition Relation Recognition
author: Jekaterina Novikova, Christian Dondrup, Ioannis Papaioannou, Oliver Lemon
mathjax: true
---
...
人类面部表情或言语语调对社会信号的识别是人机交互研究中一个热门的研究课题。口头对话社区还有一个长期的调查研究用户对话特征的满意度。然而，很少有研究涉及在口头面对面的人机交互期间检测到的多模式社交信号和语言特征的组合，以及由此产生的用户对机器人的感知。在本文中，我们展示了人类用户的不同情绪面部表情，结合人类语音的韵律特征和人机对话的特征，与用户对话后的机器人印象相关联。我们发现，用户识别的面部表情中的快乐与机器人的喜好强烈相关，而对话相关的特征（例如人的转身次数或每个机器人话语的句子数量）与将机器人感知为智能关联。此外，我们表明，面部表情，情绪特征和韵律是人类评分与感知机器人的可爱性和拟人化有关的更好的预测因素，而语言和非语言特征则更多地预测感知机器人的智能和可解释性。如此，这些特征将来可以用作基于自适应人机对话系统的原地强化学习的在线奖励信号。

##### URL
[https://arxiv.org/abs/1706.02757](https://arxiv.org/abs/1706.02757)

##### PDF
[https://arxiv.org/pdf/1706.02757](https://arxiv.org/pdf/1706.02757)
