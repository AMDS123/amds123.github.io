...
深度学习在计算机视觉的一系列任务中取得了实质性的成功。智能视频分析可以广泛应用于各种智慧城市应用的视频监控，也可以由这种强大的深度学习引擎来驱动。为了实现大规模视频分析中的深度神经网络模型的实用化，大规模的视频数据管理仍面临着前所未有的挑战。深度特征编码，而不是视频编码，为处理大规模视频监控数据提供了一个实用的解决方案。为了在深度特征编码的背景下实现互操作性，标准化是迫切而重要的。但是，由于深度学习算法的爆炸性和特征编码的特殊性，标准化过程中还存在许多问题。本文提出了面向人工智能的大规模视频管理未来的深度特征编码标准，并对这些开放性问题的现有技术，标准和可能的解决方案进行了讨论。

##### URL
[http://arxiv.org/abs/1712.01432](http://arxiv.org/abs/1712.01432)
