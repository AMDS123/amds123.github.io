...
在本文中，我们提出了一种新颖的多阶段网络架构，每个阶段都有两个分支来估计图像中的多人姿态。第一个分支预测关节的置信度图，并使用几何变换内核在置信水平上在相邻关节之间传播信息。第二分支提出了双向图结构信息模型（BGSIM），以编码丰富的上下文信息并推断不同关节之间的遮挡关系。我们动态地确定具有最高响应度的联合点作为BGSIM中传递消息的基点。基于所提出的网络结构，我们在COCO Keypoint Challenge数据集上实现了62.9的平均精度，在MPII（多人）数据集上实现了77.6的平均精度。与其他最先进的方法相比，我们的方法可以在我们选择的多人数据集上获得非常有前途的结果，无需额外的培训。

##### URL
[http://arxiv.org/abs/1805.00603](http://arxiv.org/abs/1805.00603)

##### PDF
[http://arxiv.org/pdf/1805.00603](http://arxiv.org/pdf/1805.00603)
