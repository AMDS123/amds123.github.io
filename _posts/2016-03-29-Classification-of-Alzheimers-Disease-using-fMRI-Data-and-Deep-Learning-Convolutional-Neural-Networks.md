...
date: 2016-03-29 04:30:07
categories: arXiv_CV
tags: arXiv_CV CNN Classification Deep_Learning Recognition
author: Saman Sarraf, Ghassem Tofighi
mathjax: true
---
...
近十几年来，机器学习技术尤其是生物医学领域从药物输送系统到医学成像的预测建模和模式识别已经成为帮助研究人员深入了解整个问题，解决复杂医学问题的重要手段之一。深度学习是功率学习机器学习算法在分类时提取高级特征。在本文中，我们使用卷积神经网络从正常健康的大脑分类阿尔茨海默氏脑。对这种医学数据进行分类的重要性在于潜在地开发预测模型或系统以便识别来自正常受试者的类型疾病或估计疾病的阶段。临床数据如阿尔茨海默氏病的分类一直是挑战性的，最成问题的部分一直是选择最具判别力的特征。利用卷积神经网络（CNN）和着名的LeNet-5体系结构，成功地将正常对照组阿尔茨海默病患者的功能磁共振成像数据进行分类，训练数据的检验准确率达到96.85％。这个实验表明我们CNN提取的尺度不变特征和尺度不变特征，然后是深度学习分类是功能磁共振成像中临床数据与健康数据区分最有效的方法。这种方法也使我们能够扩展我们的方法来预测更复杂的系统。

##### URL
[https://arxiv.org/abs/1603.08631](https://arxiv.org/abs/1603.08631)

##### PDF
[https://arxiv.org/pdf/1603.08631](https://arxiv.org/pdf/1603.08631)
