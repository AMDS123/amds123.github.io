...
date: 2018-09-13 08:53:14
categories: arXiv_CL
tags: arXiv_CL CNN
author: Çağrı Çöltekin, Taraka Rama
mathjax: true
---
...
本文描述了我们在CLPsych-2018共享任务范围内从儿童时期论文中预测当前和未来心理健康的努力。我们尝试了许多不同的模型，包括循环和卷积网络，泊松回归，支持向量回归，以及L1和L2正则化线性回归。我们通过L2正则化线性回归（岭回归）获得了关于训练/发展数据的最佳结果，其在任务A的官方测试中的主要指标上得到了最佳分数（从11岁时撰写的论文中预测心理健康）和任务B（从11岁时撰写的论文中预测后来的心理健康状况）。

##### URL
[https://arxiv.org/abs/1809.04838](https://arxiv.org/abs/1809.04838)

##### PDF
[https://arxiv.org/pdf/1809.04838](https://arxiv.org/pdf/1809.04838)
