---
layout: post
title: "Efficient Text Classification Using Tree-structured Multi-linear Principle Component Analysis"
date: 2018-01-20 00:15:09
categories: arXiv_CL
...
本文提出了一种新的文本数据降维技术，称为树形多线性主成分分析（TMPCA）。与传统的文本降维方法不同，TMPCA方法通过降低输入序列和句子的维数来简化下面的文本分类任务。从数学和实验上显示，TMPCA工具要求比普通主成分分析（PCA）低得多的复杂性（因此计算能力更低）。此外，通过实验结果证明，应用于TMPCA处理的数据的支持向量机（SVM）方法达到了与现有技术的递归神经网络（RNN）方法相当或更好的性能。

##### URL
[https://arxiv.org/abs/1801.06607](https://arxiv.org/abs/1801.06607)

##### PDF
[https://arxiv.org/pdf/1801.06607](https://arxiv.org/pdf/1801.06607)
