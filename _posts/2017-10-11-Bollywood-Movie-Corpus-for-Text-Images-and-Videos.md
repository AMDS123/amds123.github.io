...
在过去的几年里，已经发布了一些文本和图像的数据集。我们提出一种创建数据集的方法，用于检测和消除文本中的性别偏见。我们还包括我们在创建这个语料库时遇到的一系列挑战。在这项工作中，我们使用了来自YouTube的维基百科情节和电影预告片的电影数据。我们的宝莱坞电影语料库包含从维基百科提取的4000部电影和从1970  -  2017年发布的从YouTube提取的880部预告片。语料库包含有关每部电影的以下数据的csv文件 - 维基百科的电影标题，演员表，剧情文本，共同参考剧情文本，音轨信息，电影海报链接，电影海报标题，海报中男性人数，海报中的女性。除此之外，与每个演职人员相对应的以下数据可用 - 演员姓名，演员性别，演员动词，演员形容词，演员关系，演员中心，演员提名。我们提出一些初步的结果去偏差的任务，这表明数据集是非常有用的执行这样的任务。
