...
通过监测本地群星系中的大量恒星，我们可以通过银河系中的原始黑洞（PBH）和流星（自由浮动）矮行星等亚月亮质量紧凑物体（SULCO）来检测纳米激光事件。在由恒星质量物体引起的微透镜中，有限源尺寸效应变得重要，并且透镜持续时间变得更短（$ \ simtrm {s} $）。使用M33中$ V <26 $的恒星作为源，对于一夜观测，我们将能够检测到由银河系中的SULCO引起的$ 10 ^ {3-4} $ nanolensing事件，质量为10 ^如果SULCO构成所有暗物质成分，那么对于S / N $> 5 $的来源，可以使用-9〜M〜{〜odot} $〜$ 10 ^ { -  7} M〜{$ odot}此外，我们预计$ 10 ^ {1-2} $事件，其中S / N $> 100 $的明亮的蓝星由于质量范围为$ 10 ^ { -  11} M_ {\ odot}的SULCO的透镜而被弱放大。 $到$ 10 ^ { -  9} M _ {\ odot} $。因此，该方法将为银河系中的SULCO打开一个新窗口，否则将无法观察到。
