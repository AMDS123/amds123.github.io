...
我们介绍了ParlAI（发音为“par-lay”），这是一个用Python实现的对话研究的开放源代码软件平台，可在http URL获得。它的目标是提供一个统一的对话框模型共享，培训和测试框架， Amazon Mechanical Turk收集数据，进行人类评估和在线/强化学习;以及与其他模型进行比较的机器学习模型库，并改进现有体系结构。第一版支持20多个任务，包括SQuAD，bAbI任务，MCTest，WikiQA，QACNN，QADailyMail，CBT，bAbI对话框，Ubuntu，OpenSubtitles和VQA等流行数据集。集成了几个模型，包括神经模型，如内存网络，seq2seq和细心的LSTM。
