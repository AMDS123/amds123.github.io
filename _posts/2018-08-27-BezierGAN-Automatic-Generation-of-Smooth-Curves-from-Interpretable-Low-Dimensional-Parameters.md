...
date: 2018-08-27 14:57:17
categories: arXiv_AI
tags: arXiv_AI GAN Optimization Deep_Learning
...
许多现实世界的物体由平滑曲线设计，特别是在航空航天和船舶领域，其中设计了空气动力学形状（例如翼型）和流体动力学形状（例如船体）。为了促进这些对象的设计过程，我们提出了一种基于深度学习的生成模型，可以合成平滑曲线。该模型将低维潜在表示映射到从有理B \'ezier曲线采样的离散点序列。我们展示了我们的方法在完成合成和现实生成任务方面的表现。结果表明，该方法能够生成多样而逼真的曲线，同时保持潜在空间中一致的形状变化，有利于潜在空间设计优化或设计空间探索。

##### URL
[http://arxiv.org/abs/1808.08871](http://arxiv.org/abs/1808.08871)

##### PDF
[http://arxiv.org/pdf/1808.08871](http://arxiv.org/pdf/1808.08871)
