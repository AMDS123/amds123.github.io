...
本文提出了一个开放的工具，用于规范像素级文档图像布局分析任务的评估过程。我们推出了一个新的评估工具，既可以作为独立的Java应用程序使用，也可以作为RESTful Web服务使用。这个评估工具是免费和开源的，以便成为任何人都可以使用和贡献的通用工具。它旨在提供尽可能多的指标来调查布局分析预测，并提供一种可视化结果的简单方法。该工具评估像素级别的文档分割，并支持多标记的像素基本事实。最后，这个工具已经成功地用于ICDAR2017中世纪手稿挑战版图分析竞赛。
