...
计算机断层扫描（CT）是临床应用中流行的医学成像模式。与此同时，与CT扫描相关的X射线辐射剂量由于其对患者的潜在风险而引起公众关注。在过去几年中，主要的努力致力于低剂量CT（LDCT）方法的开发。然而，辐射剂量减少会降低信噪比（SNR），从而导致强噪声和伪影，从而降低CT图像质量。在本文中，我们提出了一种新的3D降噪方法，称为结构敏感的多尺度生成对抗网（SMGAN），以提高LDCT图像质量。具体而言，我们采用三维（3D）体积信息来提高图像质量。此外，研究了用于训练去噪模型的不同损失函数。实验表明，该方法可以有效地保留正常剂量CT（NDCT）图像的结构和纹理信息，并显着抑制噪声和伪影。三位经验丰富的放射科医师进行的定性视觉评估表明，所提出的方法可以检索更详细的信息，并且优于竞争方法。

##### URL
[http://arxiv.org/abs/1805.00587](http://arxiv.org/abs/1805.00587)

##### PDF
[http://arxiv.org/pdf/1805.00587](http://arxiv.org/pdf/1805.00587)
