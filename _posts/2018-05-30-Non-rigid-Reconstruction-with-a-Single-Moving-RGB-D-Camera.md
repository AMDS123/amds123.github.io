...
我们提出了一种新的非刚性重建方法，使用移动的RGB-D相机。目前的方法只使用场景的非刚性部分，并完全忽略刚性背景。非刚性部件通常缺乏足够的几何和光度信息来跟踪大帧到帧运动。我们的方法使用从刚性背景估计的相机姿态来进行前景追踪。这在发生大帧到帧运动的情况下实现了鲁棒的前景追踪。此外，我们提出了一个多尺度变形图，它可以在不影响重构质量的情况下改善非刚性跟踪。我们还提供了一个公开的综合数据集，用于评估非刚性重建方法。该数据集提供场景的逐帧地面真实几何，摄像机轨迹以及背景前景的蒙版。实验结果表明，我们的方法在处理更大的帧到帧运动时更加稳健，并且与最先进的方法相比提供了更好的重构。

##### URL
[http://arxiv.org/abs/1805.11219](http://arxiv.org/abs/1805.11219)

##### PDF
[http://arxiv.org/pdf/1805.11219](http://arxiv.org/pdf/1805.11219)
