...
尽管最近在二维人体姿态估计方面取得了成功，一个关键的挑战是不适定的深度模糊性质。本文提出了一种新的中间特征表示，命名为骨架图回归。它从RGB图像的不相关属性中提取结构上下文。照明和纹理。它简单，干净，可以通过反卷积网络轻松生成。我们首次证明，从骨架图单独的训练回归网络能够满足最先进的三维人体姿态估计工作的性能。我们进一步利用多个3D假设生成的功能来获得与2D姿态检测一致的合理3D姿态。我们的方法的有效性验证挑战野外数据集MPII和室内数据集Human3.6M。
