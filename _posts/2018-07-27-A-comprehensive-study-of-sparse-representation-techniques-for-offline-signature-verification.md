...
date: 2018-07-27 08:21:52
categories: arXiv_CV
tags: arXiv_CV Sparse Segmentation Detection
...
在这项工作中，提出了一种用于离线签名验证的方法，该方法利用稀疏表示的能力，以便在诸如CEDAR，MCYT-75，GPDS和UTSIG的若干签名数据集中提供最先进的验证性能。除了准确性改进之外，还有几个与稀疏表示相关的主要参数;如选择的配方，字典大小，稀疏度和阳性先验被调查。此外，可以看出，稀疏码的二阶统计量是用于形成全局签名描述符的强大的池化函数。此外，通过自动算法引入了对预处理效果的全面评估，以便选择最佳细化级别。最后，提出了一种采用针对稀疏表示问题的特殊形式的空间金字塔的分割策略，以及从BRISK关键点检测机制中出现的在签名的有意义区域上生成的描述符的增强。在最具挑战性的签名数据集上获得的最先进的结果提供了对学习特征的益处的强烈指示，即使在仅具有少量可用参考样本的WD场景中也是如此。

##### URL
[http://arxiv.org/abs/1807.05039](http://arxiv.org/abs/1807.05039)

##### PDF
[http://arxiv.org/pdf/1807.05039](http://arxiv.org/pdf/1807.05039)
