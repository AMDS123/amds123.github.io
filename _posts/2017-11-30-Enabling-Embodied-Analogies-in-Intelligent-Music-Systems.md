...
目前的方法是针对跨模态机器学习，并使用多学科的工具和方法，从广泛的领域和学科，包括音乐，系统音乐学，舞蹈，动作捕捉，人机交互，计算语言学和音频信号处理。主要工作包括：（1）将人群智慧方法应用到音乐和舞蹈表演的实例中，创建涵盖各种情绪的音乐和音乐歌词的数据集;（2）应用音频/语言机器学习技术来自动识别音乐和歌词的情感内容，以及（3）集成来自Vicon系统的运动捕捉数据和在该音乐上执行的舞者。
