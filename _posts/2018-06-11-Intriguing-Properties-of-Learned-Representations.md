...
 在本文中，我们通过已经证明在图像分类中非常成功的模型来研究学习表示的有效维度。我们专注于ResNet-18，ResNet-50和VGG-19，并观察到，在CIFAR10或CIFAR100上进行培训时，学习表现呈现出相当低的排名结构。我们提出对训练程序的修改，这进一步鼓励了学习激活的低排名结构。在经验上，我们表明这对于对抗性的例子和压缩的鲁棒性具有影响。
