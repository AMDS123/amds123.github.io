...
date: 2018-06-06 03:25:20
categories: arXiv_RO
tags: arXiv_RO Optimization SLAM
author: Xudong He, Junqiao Zhao, Lu Sun, Yewei Huang, Xinglian Zhang, Jun Li, Chen Ye
mathjax: true
---
...
在本文中，我们研究了使用多光束LiDAR进行基于向量的道路结构映射的SLAM方法。我们建议使用多段线作为主要的映射元素而不是网格单元或点云，因为基于矢量的表示是精确和轻量级的，并且它可以直接生成基于矢量的高清（HD）驱动映射，如自主驾驶系统。我们探索了：1）基于局部概率融合的道路结构的提取和矢量化。 2）道路结构框架之间基于矢量的高效匹配。 3）基于姿态图的闭环和优化。在这项研究中，我们以特定的道路结构，道路边界为例。我们将所提出的匹配方法应用于三个不同的场景中，实现了0.07的平均绝对匹配误差。我们进一步将该测绘系统应用于长度为860米的城市道路，在没有高精度GPS的帮助下，实现了平均全球精度为0.466米。

##### URL
[http://arxiv.org/abs/1804.07028](http://arxiv.org/abs/1804.07028)

##### PDF
[http://arxiv.org/pdf/1804.07028](http://arxiv.org/pdf/1804.07028)
