...
OTS44是已知有四个自由浮动行星之一。我们之前已经表明，这是一个正在积极增加的巨大磁盘的最酷，最小的已知自由浮动星球（$ \ sim $ 12 M $ _ \ rm Jup} $）。我们已经获得了这个非常年轻的磁盘承载对象的Band 6（233 GHz）ALMA连续谱数据。数据显示了一个清楚的未解决的来源检测。我们通过对年轻，质量较高，中心（子星）物体的经验相关性来获得磁盘质量估计。获得的数值范围在0.07到0.63 M $ _（\\ oplus} $（尘埃质量）之间。我们比较这个独特的磁盘的性质与最近报道的较高质量（褐矮星）年轻物体的性质，以便推断其形成机制的约束。虽然对尘埃温度的极端假设产生的磁盘质量值可能与对于更大质量的褐矮星的一般趋势略有差异，但是一系列合理的值提供了磁盘质量与$ M_尘埃}和$ M _ {*} $通过子星域到行星质量。
