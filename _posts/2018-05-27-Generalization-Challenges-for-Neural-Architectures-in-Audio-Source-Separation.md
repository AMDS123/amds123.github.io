...
最近的研究表明，可以训练递归神经网络以高保真度的混音方式将个别讲话者分开。在这里，我们探索卷积神经网络模型作为替代方案，并表明他们用较少数量级的参数实现了最新的结果。我们还刻画和比较了这三种不同测试条件下这些不同测试方法的鲁棒性和能力：更长的时间序列，间歇性噪声的添加以及训练期间未看到的不同数据集。对于最后一个条件，我们创建一个新的数据集RealTalkLibri，以测试真实环境中的源分离。我们表明，环境的声学对波形的结构和神经网络模型的整体性能具有显着的影响，卷积模型显示出优越的推广到新环境的能力。我们研究的代码可以在https://github.com/ShariqM/source_separation找到。

##### URL
[http://arxiv.org/abs/1803.08629](http://arxiv.org/abs/1803.08629)

##### PDF
[http://arxiv.org/pdf/1803.08629](http://arxiv.org/pdf/1803.08629)
