...
在传送带寿司店里，计费是一项沉重的工作，因为必须人工盘点盘子的数量并识别它们的颜色来计算价格。在繁忙的情况下，可能会出现客户多收或收费不足的错误。为了解决这个问题，我们开发了一种方法，自动识别菜肴的颜色，并使用真实图像计算总价格。我们的方法由椭圆拟合和卷积神经网络组成。实现了椭圆检测精度85％，回调率96％，分类精度92％。
