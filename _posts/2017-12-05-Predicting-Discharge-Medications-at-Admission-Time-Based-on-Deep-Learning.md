...
categories: arXiv_CL
tags: arXiv_CL CNN Deep_Learning Prediction Detection Relation
...
在患者入院后立即预测出院药物是一个重要的临床决策，它为医生提供了指导，了解在住院期间可能发生什么类型的药物治疗方案以及初始药物可能发生的变化。它还有助于药物调和过程，在出院时容易检测药物差异，以提高患者的安全性。然而，由于住院期间可用的信息有限，病人的病情可能会在住院期间发生变化，所以这些预测可能是医生难以做出的决定。在这项工作中，我们调查如何利用深度学习技术来帮助医生根据录取通知中记录的信息预测放电药物。我们构建了一个卷积神经网络，以入场券作为输入，并预测放电时放置在病人身上的药物。我们的方法能够从非结构化和嘈杂的文本中提取语义模式，并且能够捕获药物之间的药理学相关性。我们评估了25K患者就诊的方法，并与4个较强的基线进行比较。我们的方法显示，宏观平均F1分数比最佳基线增加20％。
