...
大多数提取摘要方法都集中在需要提取句子的文档主体上。然而，文件的要点可能在于侧面信息，例如通常可用于newswire文章的标题和图片标题。我们建议在单文档抽取汇总的背景下探索辅助信息。我们开发了一个单层文档摘要框架，由分层文档编码器和基于注意力的提取器组成，注意副词信息。我们在大规模的新闻数据集上评估我们的模型。我们表明，带有辅助信息的抽取摘要始终优于不使用任何辅助信息的对应方，同时具有信息量和流畅性。
