...
我们提出了一个简单的动态批处理方法，适用于一大类动态体系结构，可以持续产生超过10倍的加速。当体系结构是一个预先确定的平衡树的特殊情况下，我们提供了当体系结构未知时的性能界限和更强的界限。我们通过推断和执行程序（IEP）评估Johnson等人最近对其CLEVR数据集的视觉问题回答（VQA）结果。我们也评估了专家层稀疏的门控混合，并在最初的实现上实现了高达1000倍的加速。
