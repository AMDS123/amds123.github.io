...
我们提出了一个简单的动态批处理方法，适用于一大类动态体系结构，可以持续产生超过10倍的加速。当体系结构是未知的时候，我们提供性能边界，在体系结构是预定的平衡树的特殊情况下，我们提供更强的边界。我们通过推断和执行程序（IEP）评估Johnson等人最近对其CLEVR数据集的视觉问题回答（VQA）结果。我们还评估了专家层稀疏的门控混合，并在最初的实现上实现了高达1000倍的加速。
