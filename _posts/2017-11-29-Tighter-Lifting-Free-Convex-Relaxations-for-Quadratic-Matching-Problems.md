...
在这项工作中，我们研究置换矩阵上的二次优化问题的凸松弛。虽然现有的半定规划方法可以达到非常严格的松弛，但是它们具有强大的缺点，即它们将原始的$ n \ n次维数变量提升为$ n ^ 2次维数变量，这限制了它们的实际适用性。相比之下，在这里我们提出一个免提凸起的松弛，可以证明至少和现有的（免提）凸起松弛一样紧。我们通过实验证明，对于包括图像排列和多图匹配在内的各种问题，我们的方法优于现有的凸和非凸方法。
