...
我们提出了一种基于像素最近邻的简单方法，以理解和解释像素级任务的最新神经网络的功能。我们的目标是理解和揭示最先进的卷积神经网络的合成/预测机制。为此，我们主要分析了生成模型的综合过程和判别模型的预测机制。这项工作的主要假设是用于像素级任务的卷积神经网络学习快速合成最近邻合成/预测函数。我们关于语义分割和图像翻译的实验显示支持这一假设的定性和定量证据。
