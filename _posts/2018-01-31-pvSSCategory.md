...
历史科学手稿的研究和出版是复杂的任务，其中包括对时间实体的文本含义和推理的​​明确表示。在本文中，我们介绍了一个专门研究索绪尔手稿的跨学科项目的第一个结果。这些结果旨在满足索绪尔人文主义者所阐述的要求。它们包含一个表示时变语句和时变领域知识（尤其是术语）的模型，以及手稿语义索引的实现技术和从手稿中提取知识的时间推理。

##### URL
[http://arxiv.org/abs/1802.00295](http://arxiv.org/abs/1802.00295)

##### PDF
[http://arxiv.org/pdf/1802.00295](http://arxiv.org/pdf/1802.00295)
