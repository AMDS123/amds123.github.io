...
date: 2017-05-18 14:22:37
categories: arXiv_CV
tags: arXiv_CV
author: Guillaume Noyel (IPRI), Michel Jourlin (LHC, IPRI)
mathjax: true
---
...
我们使用对数图像处理标量乘法建立了数学形态学与探针和灰度函数之间的Asplund距离图之间的联系。我们证明该映射是函数的膨胀和侵蚀之间的比率的对数，其由结构函数构成：探针。膨胀和糜烂是从图像的格子到正函数的格子的映射。使用平坦的结构元素，Asplund距离图的表达可以通过图像的膨胀和侵蚀来简化;这些映射停留在图像的格子中。我们用一个非平坦结构函数的模式匹配来举例说明我们的方法。

##### URL
[https://arxiv.org/abs/1701.08092](https://arxiv.org/abs/1701.08092)

##### PDF
[https://arxiv.org/pdf/1701.08092](https://arxiv.org/pdf/1701.08092)
