...
以一定的艺术风格手工重新绘制图像需要专业的艺术家很长时间。单凭一个视频序列来做这件事是超乎想象的。我们提出两种计算方法，将样式从一个图像（例如，绘画）转移到整个视频序列。在我们的第一种方法中，我们适应Gatys等人的原始图像风格转换技术的视频。基于能量最小化。我们引入了新的初始化方法和新的丢失函数，即使在大运动和强遮挡的情况下也能生成一致和稳定的风格化视频序列。我们的第二种方法将视频程式化作为一个学习问题。我们提出了深入的网络架构和培训程序，使我们能够以一致和稳定的方式几乎实时地将任意长度的视频风格化。我们表明，提出的方法明显优于简单的基线定性和定量。最后，我们提出了一种方法，使这些方法也适应360度图像和视频，随着最近的虚拟现实硬件的出现。

##### URL
[https://arxiv.org/abs/1708.04538](https://arxiv.org/abs/1708.04538)

##### PDF
[https://arxiv.org/pdf/1708.04538](https://arxiv.org/pdf/1708.04538)
