...
date: 2018-08-12 18:08:38
categories: arXiv_CL
tags: arXiv_CL Text_Classification CNN Image_Classification Classification
author: Jaeyoung Kim, Sion Jang, Sungchul Choi, Eunjeong Park
mathjax: true
---
...
本文介绍了使用胶囊网络进行文本分类的实证研究。虽然已经表明胶囊网络对于图像分类是有效的，但是它们在文本领域中的有效性尚未被探索。在本文中，我们表明胶囊网络确实具有文本分类的潜力，并且它们比卷积神经网络具有几个优点。我们进一步建议一种简单的路由方法，有效地降低了动态路由的计算复杂性。我们利用七个基准数据集来证明胶囊网络以及提出的路由方法提供了可比较的结果。

##### URL
[http://arxiv.org/abs/1808.03976](http://arxiv.org/abs/1808.03976)

##### PDF
[http://arxiv.org/pdf/1808.03976](http://arxiv.org/pdf/1808.03976)
