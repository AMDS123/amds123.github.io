...
最近在计算机视觉方面的工作已经在用自然语言自动描述图像方面取得了不俗的成果这些系统中的大多数都以单一语言生成字幕，需要多种语言特定的模型来建立多语言字幕系统。我们提出了一种非常简单的技术来建立跨语言的单一统一模型，使用人工令牌来控制语言，使字幕系统更加紧凑。我们评估我们生成英文和日文字幕的方法，并显示典型的神经字幕架构能够学习可以在两种不同语言之间切换的单一模型。
