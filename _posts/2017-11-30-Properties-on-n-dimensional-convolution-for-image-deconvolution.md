...
卷积系统是线性和时间不变的，可以描述光学成像过程。在卷积系统的基础上，针对光学图像分析提出了许多反卷积技术，如提高光学图像的空间分辨率，图像去噪，图像增强等。在这里，我们给出了N维卷积的性质。通过使用这些性质，我们提出了图像反卷积方法。该方法使用一系列卷积运算来解卷积图像。我们证明了该方法具有与现有技术相似的去卷积结果。该方法的核心计算是图像卷积，因此我们的方法可以很容易地集成到GPU模式的大规模图像去卷积。
