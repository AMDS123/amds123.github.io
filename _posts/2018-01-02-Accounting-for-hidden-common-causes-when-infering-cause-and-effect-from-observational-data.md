...
从观测数据中识别因果关系很困难，很大程度上是由于存在隐藏的常见原因。在某些情况下，只有条件独立性和依赖性的恰当模式存在于数据中，例如，Y-结构 - 才有可能确定因果关系。在其他情况下，分析师故意假设隐藏的常见原因是不存在的，并推断假设的因果关系在随机试验中进行测试。在这里，我们考虑第三种方法，在数据中有足够的线索，以便可以推断隐藏的常见原因。

##### URL
[http://arxiv.org/abs/1801.00727](http://arxiv.org/abs/1801.00727)

##### PDF
[http://arxiv.org/pdf/1801.00727](http://arxiv.org/pdf/1801.00727)
