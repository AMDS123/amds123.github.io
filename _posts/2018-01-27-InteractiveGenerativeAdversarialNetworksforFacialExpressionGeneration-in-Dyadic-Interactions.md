---
layout: post
title: "InteractiveGenerativeAdversarialNetworksforFacialExpressionGeneration in Dyadic Interactions"
date: 2018-01-27 14:01:17
categories: arXiv_CV
...
社交互动是两个或更多个人之间的社交交流，个人通过互动伙伴来修改和调整他们的行为。我们的社交互动是我们生活中最基本的方面之一，可以积极地或消极地深刻地影响我们的情绪。随着对虚拟现实和虚拟角色介入交互的兴趣日益增长，人们希望将这些交互作为自然和人为的方式，以促进智能辅导系统，自动访问系统和电子学习等交互和应用方面的积极效果。在本文中，我们提出了一种方法来生成一个代理面部行为。这些行为包括面部表情和头部姿势，并且是考虑用户情感状态而产生的。我们的模型学习面部语义有意义的表示，并在二元相互作用中产生适当和时间上平滑的面部表情。

##### URL
[http://arxiv.org/abs/1801.09092](http://arxiv.org/abs/1801.09092)

##### PDF
[http://arxiv.org/pdf/1801.09092](http://arxiv.org/pdf/1801.09092)
