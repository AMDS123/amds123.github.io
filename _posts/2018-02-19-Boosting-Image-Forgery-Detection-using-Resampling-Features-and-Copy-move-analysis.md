...
逼真的图像伪造涉及拼接，重采样，克隆，区域去除和其他方法的组合。虽然重采样检测算法可有效检测拼接和重采样，但复制移动检测算法在检测克隆和区域去除方面表现优异。在本文中，我们将这些补充方法结合起来，以提高图像处理检测的整体准确性。我们使用复制移动检测方法作为预过滤步骤，并将那些未被篡改的图像传递给基于深度学习的重采样检测框架。包括近10,000个原始和篡改图像的2017 NIST Nimble挑战评估数据集在内的各种数据集的实验结果表明，当复制移动算法与不同的重采样检测算法相结合时，检测率一直增加8％-10％。

##### URL
[http://arxiv.org/abs/1802.03154](http://arxiv.org/abs/1802.03154)

##### PDF
[http://arxiv.org/pdf/1802.03154](http://arxiv.org/pdf/1802.03154)
