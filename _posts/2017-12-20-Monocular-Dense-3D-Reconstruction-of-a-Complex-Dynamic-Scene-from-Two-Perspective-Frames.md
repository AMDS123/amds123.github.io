...
本文提出了一种从两个视角框架对复杂动态场景进行单眼密集三维重建的新方法。通过对图像应用超像素过分割，我们用分段平面和刚性近似来建模一般的动态（因此非刚性）场景。这样，我们就把动态重建问题简化为一个“三维拼图”问题，这个问题从一个无组织的“超级像素汤”中分割出来。我们表明，我们的方法提供了一个有效的解决方案，从结构运动的固有相对尺度模糊。由于我们的方法并不假设模板先行，或者每个对象分割，或者关于动态场景的刚性的知识，所以它适用于广泛的场景。对合成和实际单目序列的广泛实验证明了我们的方法与现有技术方法相比的优越性。

##### URL
[http://arxiv.org/abs/1708.04398](http://arxiv.org/abs/1708.04398)

##### PDF
[http://arxiv.org/pdf/1708.04398](http://arxiv.org/pdf/1708.04398)
