...
携手与深刻的学习进步，音乐成分增加算法的表现。但是，大多数成功的模型都是为特定的音乐结构而设计的。在这里，我们提供BachProp，一个算法作曲家，可以给出足够的训练数据以任何风格生成音乐分数。为了使BachProp适应广泛的音乐风格，我们提出了一种新颖的音乐归一化表示形式，并训练一个深度网络来预测给定音乐语料库的音符转换概率。在本文中，由BachProp采样的新音乐分数通过众包与原始语料库进行比较。该评估表明，由BachProp生成的音乐分数不逊于该算法提供的原始音乐语料库。

##### URL
[https://arxiv.org/abs/1802.05162](https://arxiv.org/abs/1802.05162)

##### PDF
[https://arxiv.org/pdf/1802.05162](https://arxiv.org/pdf/1802.05162)
