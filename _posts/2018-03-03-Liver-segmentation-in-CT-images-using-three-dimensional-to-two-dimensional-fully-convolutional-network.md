...
对腹部器官的预诊断和治疗越来越需要CT扫描分析。腹部CT扫描的自动器官分割可以帮助放射科医师更快地分析扫描，并以更少的误差分割器官图像。然而，现有的方法不足以对事故和紧急情况下的受害者进行细分。在本文中，我们提出了一个有效的肝脏分割与我们的3D到2D全连接网络（3D-2D-FCN）。通过器官边界上的条件随机场来增强分段掩模。因此，我们在不到一分钟的时间内以Dice分数为93.52分段了一个目标肝脏。

##### URL
[http://arxiv.org/abs/1802.07800](http://arxiv.org/abs/1802.07800)

##### PDF
[http://arxiv.org/pdf/1802.07800](http://arxiv.org/pdf/1802.07800)
