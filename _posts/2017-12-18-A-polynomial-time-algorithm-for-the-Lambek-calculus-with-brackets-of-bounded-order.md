...
date: 2017-12-18 10:39:22
categories: arXiv_CL
tags: arXiv_CL
author: Max Kanovich, Stepan Kuznetsov, Glyn Morrill, Andre Scedrov
mathjax: true
---
...
兰贝克演算是范畴语法的逻辑基础，语法范式是语法逻辑和解析演绎。 Pentus（2010）给出了一个多项式时间算法，用于确定Lambek演算中有界深度公式的可证性，允许有空的前提。 Pentus算法是基于证明网络的制表化。带括号的Lambek微积分是Lambek微积分与括号形式的保守扩展，适用于语法域的建模。在本文中，我们给出了一个算子的可证性的Lambek演算与括号允许空前提。当公式深度和括号嵌套深度都有界时，我们的算法在多项式时间运行。它结合了Pentus风格的证明网的制表和自动机理论处理的包围。

##### URL
[http://arxiv.org/abs/1705.00694](http://arxiv.org/abs/1705.00694)

##### PDF
[http://arxiv.org/pdf/1705.00694](http://arxiv.org/pdf/1705.00694)
