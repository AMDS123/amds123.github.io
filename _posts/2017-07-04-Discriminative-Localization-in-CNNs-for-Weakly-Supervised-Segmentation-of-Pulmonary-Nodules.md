...
date: 2017-07-04 17:54:57
categories: arXiv_CV
tags: arXiv_CV Segmentation CNN Image_Classification Classification Detection
...
肺部计算机断层扫描（CT）扫描的肺结节的自动检测和分割可以促进早期肺癌诊断。现有的用于CT扫描的自动化结节分割的监督方法需要基于体素的注释来进行训练，这需要花费劳力和时间。在这项工作中，我们提出了一个弱监督的方法，只生成精确的体素级结节分割与图像级标签训练。通过对卷积神经网络（CNN）进行图像分类训练，我们提出的方法从不同尺度的卷积单元的激活图学习判别区域，并用新的候选筛选框架识别真实的结节位置。在公开的LIDC-IDRI数据集上的实验结果表明，与完全监督的基于CNN的分割方法相比，我们的弱监督结节分割框架实现了竞争性能。

##### URL
[https://arxiv.org/abs/1707.01086](https://arxiv.org/abs/1707.01086)

##### PDF
[https://arxiv.org/pdf/1707.01086](https://arxiv.org/pdf/1707.01086)
