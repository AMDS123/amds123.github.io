...
虽然fMRI等现代成像技术为体内研究大脑开辟了令人兴奋的新的可能性，但组织切片仍然是在单个神经元水平上研究大脑解剖结构的最佳方法。自1909年以来，组织学图谱变化不大，大脑局部化仍然是一个劳动密集型过程，只有经验丰富的神经解剖学家才能完成。艾伦脑图谱等现有数字地图集仅限于无法识别神经元细节结构的低分辨率图像。我们已经开发了一个数字图集方法，结合关于大脑的三维组织和不同结构的神经元的详细纹理信息。使用这种方法，我们为小鼠脑干和脑中脑开发了一个地图集，这两个地区目前没有好的地图集。我们的图谱是“活跃的”，因为它可以用来自动对齐组织学图谱，从而减少了神经解剖学家的工作。

##### URL
[http://arxiv.org/abs/1702.08606](http://arxiv.org/abs/1702.08606)

##### PDF
[http://arxiv.org/pdf/1702.08606](http://arxiv.org/pdf/1702.08606)
