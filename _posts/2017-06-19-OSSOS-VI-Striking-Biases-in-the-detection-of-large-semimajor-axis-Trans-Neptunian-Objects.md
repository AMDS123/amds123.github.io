...
date: 2017-06-19 17:40:56
categories: arXiv_CV
tags: arXiv_CV Survey Detection
author: Cory Shankman, JJ Kavelaars, Michele Bannister, Brett Gladman, Samantha Lawler, Ying-Tung Chen, Marian Jakubik, Nathan Kaib, Mike Alexandersen, Stephen Gwyn, Jean-Marc Petit, Kathryn Volk
mathjax: true
---
...
大型半长轴跨海王星物体（TNO）的聚集，但很小的集合在其轨道的方向上表现出明显的聚集。这种聚类必须代表这些TNO的固有分布，否则就会出现这样一小组被检测物体的观察偏差和/或统计学上预期的变化。在不同的和独立的调查中发现了聚集的TNO，这导致了这些检测因此没有观察偏差。这种明显的聚集导致了所谓的“9号行星”假说，即超地球目前居住在遥远的太阳系中，并导致这种聚集。外太阳系起源调查（OSSOS）是一个在2013  -  2017年在加拿大 - 法国 - 夏威夷望远镜上运行的大型项目，发现了800多个新的TNO。 OSSOS的主要设计目标之一是仔细确定所发现样本内的观察偏差。我们展示了检测具有大半长轴的TNO的惊人和非直观的偏见。八个大的半长轴OSSOS检测是一个独立的数据集，其大小与以前的研究中使用的砾岩样本相当。我们得出这样的结论：OSSOS样本的轨道分布与从一个统一的底层角分布中检测到的一致。
