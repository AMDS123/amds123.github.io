...
在本文中，我们提出了一个回归框架，涉及几个机器学习模型，以估计基于高光谱数据的水参数。在德国易北河上进行的多传感器野外活动的测量代表了基准数据集。它包含高光谱数据和五种水参数叶绿素a，绿藻，硅藻，CDOM和浊度。我们将高维数据的PCA应用为可能的预处理步骤。然后，我们使用和不使用此预处理步骤来评估回归框架的性能。该框架的回归结果清楚地揭示了基于机器学习的高光谱数据估计水参数的潜力。拟议的框架为进一步调查提供了基础，例如调整框架以估算不同内陆水域的水参数。

##### URL
[http://arxiv.org/abs/1805.01361](http://arxiv.org/abs/1805.01361)

##### PDF
[http://arxiv.org/pdf/1805.01361](http://arxiv.org/pdf/1805.01361)
