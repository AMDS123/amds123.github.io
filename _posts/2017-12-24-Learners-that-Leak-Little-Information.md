...
我们研究的学习算法仅限于使用输入样本中的少量信息。我们介绍一类学习算法，我们称之为d位信息学习器，它是一种算法，它的输出在其输入上传达最多d比特的信息。这项工作的核心主题是这样的算法一般化。
 我们关注这些算法的学习能力，并证明样本复杂性的界限与置信度和误差参数之间的紧密依赖关系。我们还观察到与研究良好的概念（如样本压缩方案，Occam的剃须刀，PAC-Bayes和差分隐私）的联系。
 我们讨论一种方法，使我们能够证明算法揭示其输入的信息量的上限，并且通过展示一个简单的概念类来提供一个下界，每个（可能是随机的）经验风险最小化者必须揭示大量信息。另一方面，我们表明，在依赖分布的设置中，每个VC类都有经验风险最小化，不会泄露大量的信息。
