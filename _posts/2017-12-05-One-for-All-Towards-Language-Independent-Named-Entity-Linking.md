...
categories: arXiv_CL
tags: arXiv_CL GAN
author: Avirup Sil, Radu Florian
---
...
实体链接（EL）是通过将文本与提及的提及性数据库（人员，组织等）中的条目相关联来消除文本中的提及的任务。大多数以前的EL研究主要集中在一种语言，英语，不太关注其他语言，如西班牙语或中文。在本文中，我们介绍一个语言独立实体链接系统LIEL，它提供了一个EL框架，这个框架一旦用一种语言进行了培训，就可以在不改变的情况下在很多不同的语言上工作得非常好。 LIEL对整个文档进行联合全局预测，采用具有许多域和语言无关特征函数的歧视性排序框架。在众多的基准数据集上进行的实验表明，所提出的系统，曾经训练过一种语言，英语，胜过英语中的几个最先进的系统（4分），训练有素的模型在西班牙语上也工作得很好（14分比竞争对手的系统更好），证明了这种方法的可行性。
