---
layout: post
title: "LOOP Descriptor: Encoding Repeated Local Patterns for Fine-grained Visual Identification of Lepidoptera"
date: 2017-10-25 16:06:13
categories: arXiv_CV
...
这封信介绍了LOOP二进制描述符（局部最优导向模式），它将旋转不变性编码到主要公式本身中。这使得旋转不变性的任何后处理阶段是冗余的，并且提高了准确性和时间复杂度。我们认为细粒鳞翅目（蛾/蝴蝶）物种识别是代表性的问题，因为它涉及重复可能被用于区分的局部模式和纹理。我们评估LOOP对其前辈的表现，以及其他一些流行的描述。除了标准基准的实验之外，我们还在新西兰鳞翅目引进了一个新的小型图像数据集。与以前的二进制描述符相比，所有评估数据集的循环表现都一样好或更好。所提出的方法的新数据集和演示代码可以通过主要作者的学术网页和GitHub获得。

##### URL
[https://arxiv.org/abs/1710.09317](https://arxiv.org/abs/1710.09317)

##### PDF
[https://arxiv.org/pdf/1710.09317](https://arxiv.org/pdf/1710.09317)
