...
date: 2015-06-24 02:15:17
categories: arXiv_CV
tags: arXiv_CV Object_Detection Detection
author: Jian Guo, Stephen Gould
mathjax: true
---
...
我们报告了最近DeepEnsembleCoco提交给PASCAL VOC 2012挑战的方法，该方法在对象检测任务上实现了最先进的性能。我们的方法是Girshick：CVPR14提出的R-CNN模型的一个变种，对训练和评估有两个关键的改进。首先，我们的方法构建了具有不同体系结构的深度CNN模型的集合，这些体系互为补充。其次，我们使用Microsoft COCO数据集中的图像增强了PASCAL VOC训练集，以显着扩大训练数据量。重要的是，我们选择Microsoft COCO图像的一个子集，以与PASCAL VOC任务保持一致。 PASCAL VOC评估服务器上的结果表明，我们提出的方法在提交时比PASCAL VOC 2012检测任务中的所有方法都要优越。
