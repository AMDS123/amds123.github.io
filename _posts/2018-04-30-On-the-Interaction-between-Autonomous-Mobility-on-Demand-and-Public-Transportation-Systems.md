...
date: 2018-04-30 15:35:36
categories: arXiv_RO
tags: arXiv_RO
author: Mauro Salazar, Federico Rossi, Maximilian Schiffer, Christopher H. Onder, Marco Pavone
mathjax: true
---
...
在本文中，我们研究了多式联运自主移动随需应变（AMoD）的模型和协调政策，其中一系列自动驾驶车辆与公共交通提供了随需移动。具体来说，我们首先提出了一个联运AMoD的网络流量模型，其中我们捕捉到了AMoD和公共交通之间的耦合，目标是最大化社会福利。其次，利用这种模式，我们设计了一个定价和收费方案，允许在自私代理人假设完美市场的情况下实现社会最优化。最后，我们为纽约市提供一个真实案例研究。我们的研究结果表明，与AMoD系统隔离运行相比，AMoD车队和公共交通之间的协调可以带来显着的收益。

##### URL
[https://arxiv.org/abs/1804.11278](https://arxiv.org/abs/1804.11278)

##### PDF
[https://arxiv.org/pdf/1804.11278](https://arxiv.org/pdf/1804.11278)
