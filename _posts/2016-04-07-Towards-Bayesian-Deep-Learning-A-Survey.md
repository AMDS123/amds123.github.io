...
date: 2016-04-07 06:17:44
categories: arXiv_CV
tags: arXiv_CV Review Survey Inference Deep_Learning Relation Recommendation Recognition
...
虽然视觉对象识别和文本理解等感知任务在人的智能中起着重要作用，但涉及推理，推理和规划的后续任务需要更高水平的智能。在过去的几年中，使用深度学习模式在许多感知任务中取得了重大进展。然而，对于更高级的推理，具有贝叶斯性质的概率图模型仍然更加强大和灵活。为了实现既涉及感知又涉及推理的综合智能，将深度学习和贝叶斯模型紧密结合在一个原则性的概率框架（我们称之为贝叶斯深度学习）中是自然而然的。在这个统一的框架下，使用深度学习的文本或图像的感知可以提高高级推理的性能，反过来，推理过程的反馈能够增强文本或图像的感知。本调查提供了贝叶斯深度学习的一般介绍，并回顾了其在推荐系统，主题模型和控制方面的最新应用。在这次调查中，我们还讨论了贝叶斯深度学习和其他相关话题如贝叶斯神经网络处理之间的关系和差异。

##### URL
[https://arxiv.org/abs/1604.01662](https://arxiv.org/abs/1604.01662)

##### PDF
[https://arxiv.org/pdf/1604.01662](https://arxiv.org/pdf/1604.01662)
