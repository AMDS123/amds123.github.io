...
我们通过分析用户贡献的吉他谱的大型数据集来调查音乐和弦与歌词之间的关联。受到和弦的情感内容反映在相应歌词中使用的词语的启发，我们分析了歌词与和弦类别之间的联系。我们还研究了不同音乐类型，历史时期和地理区域的和弦和歌词的使用模式。我们的整体结果证实了以前已知的主要和弦和正价之间的关联。我们也报告了这个协会在各个地区，流派和时代的广泛变化。我们的结果表明可能存在不同的其他类型的和弦的情感联想。
