...
对象跟踪和定位是一项复杂的任务，通常需要超出低功耗嵌入式相机功能的处理能力。本文提出了一种利用多视点二进制关键点描述符进行实时对象跟踪和定位的新方法。所提出的方法提供了处理能力，准确度和网络带宽之间的折中，并且已经使用多个分布式低功率智能相机进行了测试。另外，还提出了多种优化技术来提高低功耗嵌入式系统关键点描述符的性能。
