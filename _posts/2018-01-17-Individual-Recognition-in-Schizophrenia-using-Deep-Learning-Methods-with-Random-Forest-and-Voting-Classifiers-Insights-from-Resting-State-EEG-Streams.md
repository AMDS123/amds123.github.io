...
最近，人们对监测个体识别系统的大脑活动越来越感兴趣。到目前为止，这些作品主要集中在一些先进的大脑监测模式收集的单通道数据或碎片数据。在这项研究中，我们提出了基于时空静息状态脑电图（EEG）数据的新的个体识别方案。此外，不使用人为设计的程序所衍生的特征，而是开发了旨在自动提取个人独特特征的改进的深度学习体系结构来进行分类。我们设计的深度学习框架证明了用随机森林取代$ softmax $层的小而一致的优点。此外，在设计的神经网络的顶部添加投票层，以解决由EEG流产生的分类问题。最后，通过各种实验来评估所设计的深度学习架构的性能。结果表明，所提出的基于EEG的个体识别方案产生高度的分类准确性：高风险（CHR）个体的特征为$ 81.6 \％$，临床稳定的首发精神分裂症（FES）患者为$ 96.7 \％$，$ 99.2健康对照（HC）的\％$。

##### URL
[http://arxiv.org/abs/1707.03467](http://arxiv.org/abs/1707.03467)

##### PDF
[http://arxiv.org/pdf/1707.03467](http://arxiv.org/pdf/1707.03467)
