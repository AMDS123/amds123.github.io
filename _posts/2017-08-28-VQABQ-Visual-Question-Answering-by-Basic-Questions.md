...
以图像和问题作为我们方法的输入，它可以输出关于给定图像的查询问题的基于文本的答案，即所谓的视觉问答（VQA）。在我们的算法中有两个主要模块。给定关于图像的自然语言问题，第一个模块将该问题作为输入，然后输出主要给定问题的基本问题。第二个模块将主要问题，图像和这些基本问题作为输入，然后输出主要问题的文本答案。我们将基本问题的生成问题作为LASSO优化问题，提出了如何利用这些基本问题来解答主要问题的标准。我们的方法在具有挑战性的VQA数据集上进行评估，并获得最新的准确性，60.34％的开放式任务。
