---
layout: post
title: "Approximate Reflection Symmetry in a Point Set: Theory and Algorithm with an Application"
date: 2018-01-10 09:30:19
categories: arXiv_CV
...
我们提出了一种检测近似反射对称性的算法，该算法存在于包含畸变反射对称图案的属于$ \ mathbb {R} ^ d $的一组体积分布点中。我们提出检测近似反射对称性的问题是建立彼此反射的点之间的对应关系并确定反射对称性变换的问题。我们制定了一个优化框架，其中建立对应关系的问题相当于解决线性分配问题，确定反射对称性变换的问题在光滑黎曼流形上是最优化问题。所提出的方法根据点的分布来估计对称性并且是独立的描述符。我们通过改变完美的反射对称模式中的失真量来评估我们的方法的鲁棒性，其中我们通过不同量的扰动扰动每个点。我们通过将其应用于二维反射对称性检测问题以及相关比较来证明该方法的有效性。

##### URL
[http://arxiv.org/abs/1706.08801](http://arxiv.org/abs/1706.08801)

##### PDF
[http://arxiv.org/pdf/1706.08801](http://arxiv.org/pdf/1706.08801)
