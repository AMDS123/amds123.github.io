...
date: 2018-09-07 14:28:15
categories: arXiv_CV
tags: arXiv_CV Image_Caption Adversarial Attention GAN Face Represenation_Learning Quantitative Recognition
...
可靠的面部表情识别在人机交互中起着关键作用。然而，迄今为止提出的大多数面部表情分析方法很少或根本不关注对用户隐私的保护。在本文中，我们提出了一种隐私保护表示 - 学习变分生成对抗网络（PPRL-VGAN）来学习明确地从身份信息中解开的图像表示。同时，这种表示从面部表情识别和生成的角度来看是有区别的，因为它允许表达等效的面部图像合成。我们在各种威胁情景下对两个公共数据集评估建议的模型。定量和定性结果表明，我们的方法在保护隐私和数据效用之间取得了平衡。我们进一步证明我们的模型可以有效地应用于其他任务，如表达变形和图像完成。

##### URL
[http://arxiv.org/abs/1803.07100](http://arxiv.org/abs/1803.07100)

##### PDF
[http://arxiv.org/pdf/1803.07100](http://arxiv.org/pdf/1803.07100)
