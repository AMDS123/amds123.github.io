...
世界上约有8％的男性人口受到确定类型的色觉障碍的影响，其从局部到完全减少区分某些颜色的能力是不同的。相当数量的色盲人能够终身生活，而不知道他们有色觉障碍和异常。如今信息技术和计算机科学的发展，特别是图像处理技术和计算机图形学，对于帮助自适应色盲校正工具的发展至关重要。本文提出了一种基于模糊逻辑的软件工具来评估一个人的色盲类型和程度。为了模拟多个色盲程度，本文使用模糊参数修改了经典的基于线性变换的仿真方法。我们还提出了四种基于模糊方法校正色盲的新方法：方法A和方法B，有和没有直方图均衡。所有的方法都是基于线性变换和直方图操作的组合。为了评估结果，我们实施了基于网络的调查，以根据优化以获得最佳结果来区分图像中的不同元素。从40名志愿者获得的结果证明，采用直方图均衡化的方法B对约47％的志愿者获得了最好的结果。
