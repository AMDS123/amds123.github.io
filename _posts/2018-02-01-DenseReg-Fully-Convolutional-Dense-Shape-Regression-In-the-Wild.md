...
在这项工作中，我们建立了RGB图像和基于表面的人体表示之间的密集对应关系，我们称之为密集人体姿态估计。我们首先通过引入一个有效的注释流水线来收集COCO数据集中出现的5万人的密集对应关系。然后，我们使用我们的数据集来训练基于CNN的系统，在野外提供密集的对应关系，即存在背景，遮挡和尺度变化。我们通过培训能够填补缺失的实际价值的“修补”网络来提高我们的培训集的有效性，并就过去可以达到的最佳结果报告明显的改进。我们尝试全卷积网络和区域模型，并观察后者的优越性;我们通过级联进一步提高准确性，获得一个实时传递高度准确结果的系统。补充材料和视频在项目页面<a href="http://densepose.org">此http URL </a>上提供

##### URL
[http://arxiv.org/abs/1802.00434](http://arxiv.org/abs/1802.00434)

##### PDF
[http://arxiv.org/pdf/1802.00434](http://arxiv.org/pdf/1802.00434)
