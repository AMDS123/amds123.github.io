...
与传统视频相比，全景视频支持头戴式显示器，支持球形观看方向，提供交互式的沉浸式体验。不幸的是，据我们所知，视频质量评估（VQA）方法，无论是主观的还是客观的，对于全景视频都是很少的。本文提出了评价受损全景视频质量损失的主观和客观方法。具体来说，我们首先建立一个新的数据库，其中包括从几个主题观看全景视频序列的观看方向数据。然后，从我们的数据库，我们发现在不同主题的观看方向高度一致。观看方向通常分布在前部区域的中央，但有时也会落入与视频内容相关的其他区域。鉴于这一发现，我们提出了一种主观VQA方法，用于分别以整体DMOS（O-DMOS）和矢量化DMOS（V-DMOS）来衡量整个和区域全景视频的不同平均意见得分（DMOS）。此外，针对全景视频的人类感知特性，提出了两种客观的全景视频VQA方法。一种方法称量像素在距前景区域中心的距离方面的失真，这考虑了人类在全景中的偏好。另一种方法根据视频内容预测观看方向，然后利用预测的观看方向为我们的客观VQA方法中的每个像素的失真分配权重。最后，我们的实验结果验证了本文提出的主观和客观两种方法都可以提供最先进的全景视频VQA。
