...
date: 2018-08-06 03:04:35
categories: arXiv_AI
tags: arXiv_AI Knowledge_Graph Knowledge Classification Recognition
...
在Linked Open Data上发布的不断增长的数据集主要包含百科全书信息。但是，缺少从非结构化实时源提取的高质量结构化和语义注释数据集。在本文中，我们提出了使用Twitter上发布的新闻标题的案例研究来开发相互关联事件的知识图的原则，这是一个实时和有意义的新信息来源。我们代表了包含所需任务的基本管道，包括选择背景数据模型，事件注释（即事件识别和分类），实体注释和最终相互关联的事件。最先进的技术仅限于用于识别和分类事件的特定领域场景，而本文则发挥了与领域无关的道路图的作用，用于开发相互关联事件的知识图。

##### URL
[http://arxiv.org/abs/1808.02022](http://arxiv.org/abs/1808.02022)

##### PDF
[http://arxiv.org/pdf/1808.02022](http://arxiv.org/pdf/1808.02022)
