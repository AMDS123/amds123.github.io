---
layout: post
title: "EBIC: an artificial intelligence-based parallel biclustering algorithm for pattern discovery"
date: 2018-01-09 17:13:07
categories: arXiv_AI
tags: arXiv_AI
...
本文介绍了一种基于人工智能（AI）的新型双聚类算法。称为EBIC的方法旨在检测复杂数据中具有生物意义的顺序保存模式。该算法可能是第一个能够在真实基因表达数据集中准确发现超过50％复杂模式的算法。它也是为具有多个图形处理单元（GPU）的并行环境设计的极少数双聚方法之一。我们证明EBIC在综合和遗传数据集的恢复和相关性方面优于最先进的双组分方法。 EBIC的结果也比最精确的参考算法快12倍。所提出的算法预计将被添加到用于分析数据集的无监督机器学习算法的集合中，包括来自大规模基因组研究的那些算法。

##### URL
[http://arxiv.org/abs/1801.03039](http://arxiv.org/abs/1801.03039)

##### PDF
[http://arxiv.org/pdf/1801.03039](http://arxiv.org/pdf/1801.03039)
