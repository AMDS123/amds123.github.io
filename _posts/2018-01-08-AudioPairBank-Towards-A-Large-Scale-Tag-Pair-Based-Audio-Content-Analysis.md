...
date: 2018-01-08 21:36:04
categories: arXiv_CL
tags: arXiv_CL Relation Recognition
author: Sebastian Sager, Benjamin Elizalde, Damian Borth, Christian Schulze, Bhiksha Raj, Ian Lane
mathjax: true
---
...
最近，声音识别已被用于识别声音，如汽车和河流。然而，声音有细微差别，可以用形容词 - 名词对（比如慢车）和动词 - 名词对（比如飞行昆虫）更好地描述，正在探索之中。因此，本文研究音频内容与形容词 - 名词对和动 - 名对之间的关​​系。由于缺少具有这些注释的数据集，我们收集并处理了AudioPairBank语料库，该语料库由总共1,123对和超过33,000个音频文件组成。其中一个贡献是之前无法收集使用这些类型标签录音的挑战和影响的文件。第二个贡献是通过声音识别实验来显示音频内容和标签之间的相关程度，这产生了70％的准确度结果，因此也提供了性能基准。本文的结果和研究鼓励对音频细微差别的进一步探索，旨在补充在多媒体分析中对图像和文本进行类似的研究。

##### URL
[http://arxiv.org/abs/1607.03766](http://arxiv.org/abs/1607.03766)

##### PDF
[http://arxiv.org/pdf/1607.03766](http://arxiv.org/pdf/1607.03766)
