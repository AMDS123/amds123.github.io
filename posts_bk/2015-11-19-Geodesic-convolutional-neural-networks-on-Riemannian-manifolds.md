...
特征描述符在广泛的几何分析和处理应用中起着至关重要的作用，包括形状对应，检索和分割。在本文中，我们引入测地线卷积神经网络（GCNN），将卷积网络（CNN）范式推广到非欧几里得流形。我们的构建基于极坐标的局部测地系统来提取“块”，然后通过级联的滤波器和线性和非线性算子。过滤器和线性组合权重的系数是优化变量，其被学习以最小化任务特定的成本函数。我们使用GCNN来学习不变的形状特征，从而在形状描述，检索和对应等问题上达到最新的性能。

##### URL
[https://arxiv.org/abs/1501.06297](https://arxiv.org/abs/1501.06297)

##### PDF
[https://arxiv.org/pdf/1501.06297](https://arxiv.org/pdf/1501.06297)
